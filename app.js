...
const DAILY_CHALLENGES = [
  ...
  { title: 'What is an API key?', question: 'An API key is used to...', options: ['Encrypt user passwords', 'Identify and authenticate who is making a request to an API', 'Speed up API responses', 'Format JSON data'], correct: 1, explanation: 'An API key is a unique identifier passed with request
