...
function renderLearnHub() {
  ...
  var html = '<style id="hub-override">' +
    ...
    /* Cards — raised 3D slab with visible thickness and hard elevation shadow */
    '.fc-card{min-width:130px!important;background:rgba(6,12,30,0.96)!important;border:1px solid rgba(255,255,255,0.18)!important;border-bottom:4px solid rgba(0,0,0,0.90)!important;border-radius:10px!important;backdrop-filter:blur(18px)!important;-webkit-backdrop-filter:blur(18px)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,0.22),0 2px 0 rgba(0,0,0,0.88),0 4px 0 rgba(0,0,0,0.80),0 6px 0 rgba(0,0,0,0.70),0 8px 0 rgba(0,0,0,0.58),0 12px 20px rgba(0,0,0,0.97),0 28px 44px rgba(0,0,0,0.82),0 48px 72px rgba(0,0,0,0.50)!important;transform:translateY(-2px)!important;}' +
    /* Card text */
