...
function renderLearnHub() {
  ...
  var html = '<style id="hub-override">' +
    ...
    '.fc-header-title{color:#eef6ff!important;background:none!important;-webkit-text-fill-color:unset!important;-webkit-text-stroke:1.2px rgba(180,230,255,0.55)!important;animation:none!important;font-size:clamp(42px,7vw,78px)!important;font-weight:900!important;line-height:1.05!important;letter-spacing:-0.5px!important;text-shadow:0 0 3px rgba(0,0,0,1),0 0 8px rgba(0,0,0,1),0 1px 0 rgba(28,72,155,0.96),0 2px 0 rgba(22,58,132,0.92),0 3px 0 rgba(16,45,112,0.88),0 4px 0 rgba(11,34,92,0.84),0 5px 0 rgba(7,24,72,0.80),0 6px 0 rgba(4,16,54,0.76),0 8px 16px rgba(0,0,0,0.97),0 14px 32px rgba(0,0,0,0.82),0 0 50px rgba(90,200,255,0.80),0 0 90px rgba(90,200,255,0.46),0 0 140px rgba(90,200,255,0.22)!important;}' +
    /* Subtitle */
