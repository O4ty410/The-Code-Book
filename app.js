...
function populateDashboard() {
  ...
  if (!hasStarted) {
    // New user \u2014 show the landing screen with background image
  ...
  // Returning user \u2014 show dashboard on cover
  var cover = document.getElementById('cover');
...
function launchApp() {
  ...
  // Completely remove the landing screen and cover from the DOM
  var landing = document.getElementById('new-user-landing');
