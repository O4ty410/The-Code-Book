...
const DAILY_CHALLENGES = [
  ...
  { title: 'Component state', question: 'In React, "state" refers to...', options: ['The CSS styles of a component', 'Data that belongs to a component and can change over time', 'The server location of the app', 'The HTML structure of the page'], correct: 1, explanation: 'State is data that lives inside a component and can change. When state changes, React re-renders the component to reflect the new data. This is the core idea behind reactive UIs 
