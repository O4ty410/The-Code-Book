 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(D,j){var J=D.length;D.push(j);e:for(;0<J;){var ae=J-1>>>1,de=D[ae];if(0<r(de,j))D[ae]=j,D[J]=de,J=ae;else break e}}function n(D){return D.length===0?null:D[0]}function i(D){if(D.length===0)return null;var j=D[0],J=D.pop();if(J!==j){D[0]=J;e:for(var ae=0,de=D.length,Ne=de>>>1;ae<Ne;){var Be=2*(ae+1)-1,De=D[Be],Q=Be+1,ge=D[Q];if(0>r(De,J))Q<de&&0>r(ge,De)?(D[ae]=ge,D[Q]=J,ae=Q):(D[ae]=De,D[Be]=J,ae=Be);else if(Q<de&&0>r(ge,J))D[ae]=ge,D[Q]=J,ae=Q;else break e}}return j}function r(D,j){var J=D.sortIndex-j.sortIndex;return J!==0?J:D.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var a=Date,o=a.now();e.unstable_now=function(){return a.now()-o}}var l=[],u=[],f=1,h=null,c=3,p=!1,m=!1,_=!1,g=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function M(D){for(var j=n(u);j!==null;){if(j.callback===null)i(u);else if(j.startTime<=D)i(u),j.sortIndex=j.expirationTime,t(l,j);else break;j=n(u)}}function E(D){if(_=!1,M(D),!m)if(n(l)!==null)m=!0,z(T);else{var j=n(u);j!==null&&H(E,j.startTime-D)}}function T(D,j){m=!1,_&&(_=!1,d(S),S=-1),p=!0;var J=c;try{for(M(j),h=n(l);h!==null&&(!(h.expirationTime>j)||D&&!R());){var ae=h.callback;if(typeof ae=="function"){h.callback=null,c=h.priorityLevel;var de=ae(h.expirationTime<=j);j=e.unstable_now(),typeof de=="function"?h.callback=de:h===n(l)&&i(l),M(j)}else i(l);h=n(l)}if(h!==null)var Ne=!0;else{var Be=n(u);Be!==null&&H(E,Be.startTime-j),Ne=!1}return Ne}finally{h=null,c=J,p=!1}}var b=!1,w=null,S=-1,x=5,P=-1;function R(){return!(e.unstable_now()-P<x)}function N(){if(w!==null){var D=e.unstable_now();P=D;var j=!0;try{j=w(!0,D)}finally{j?U():(b=!1,w=null)}}else b=!1}var U;if(typeof v=="function")U=function(){v(N)};else if(typeof MessageChannel<"u"){var k=new MessageChannel,L=k.port2;k.port1.onmessage=N,U=function(){L.postMessage(null)}}else U=function(){g(N,0)};function z(D){w=D,b||(b=!0,U())}function H(D,j){S=g(function(){D(e.unstable_now())},j)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(D){D.callback=null},e.unstable_continueExecution=function(){m||p||(m=!0,z(T))},e.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):x=0<D?Math.floor(1e3/D):5},e.unstable_getCurrentPriorityLevel=function(){return c},e.unstable_getFirstCallbackNode=function(){return n(l)},e.unstable_next=function(D){switch(c){case 1:case 2:case 3:var j=3;break;default:j=c}var J=c;c=j;try{return D()}finally{c=J}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(D,j){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var J=c;c=D;try{return j()}finally{c=J}},e.unstable_scheduleCallback=function(D,j,J){var ae=e.unstable_now();switch(typeof J=="object"&&J!==null?(J=J.delay,J=typeof J=="number"&&0<J?ae+J:ae):J=ae,D){case 1:var de=-1;break;case 2:de=250;break;case 5:de=1073741823;break;case 4:de=1e4;break;default:de=5e3}return de=J+de,D={id:f++,callback:j,priorityLevel:D,startTime:J,expirationTime:de,sortIndex:-1},J>ae?(D.sortIndex=J,t(u,D),n(l)===null&&D===n(u)&&(_?(d(S),S=-1):_=!0,H(E,J-ae))):(D.sortIndex=de,t(l,D),m||p||(m=!0,z(T))),D},e.unstable_shouldYield=R,e.unstable_wrapCallback=function(D){var j=c;return function(){var J=c;c=j;try{return D.apply(this,arguments)}finally{c=J}}}})(gg);mg.exports=gg;var PS=mg.exports;/**
 * @license React
...
`)+`
`+d);const M=v+g+a,E=v+d+o,T=Om(r,r.VERTEX_SHADER,M),b=Om(r,r.FRAGMENT_SHADER,E);r.attachShader(_,T),r.attachShader(_,b),n.index0AttributeName!==void 0?r.bindAttribLocation(_,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function w(R){if(e.debug.checkShaderErrors){const N=r.getProgramInfoLog(_)||"",U=r.getShaderInfoLog(T)||"",k=r.getShaderInfoLog(b)||"",L=N.trim(),z=U.trim(),H=k.trim();let D=!0,j=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(D=!1,typeof e.debug.onShaderError=="function")e.debug.onShaderError(r,_,T,b);else{const J=Bm(r,T,"vertex"),ae=Bm(r,b,"fragment");st("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
Program Info Log: `+L+`
`+J+`
`+ae)}else L!==""?Ve("WebGLProgram: Program Info Log:",L):(z===""||H==="")&&(j=!1);j&&(R.diagnostics={runnable:D,programLog:L,vertexShader:{log:z,prefix:g},fragmentShader:{log:H,prefix:d}})}r.deleteShader(T),r.deleteShader(b),S=new Pl(r,_),x=Ix(r,_)}let S;this.getUniforms=function(){return S===void 0&&w(this),S};let x;this.getAttributes=function(){return x===void 0&&w(this),x};let P=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return P===!1&&(P=r.getProgramParameter(_,Mx)),P},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(_),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=Ex++,this.cacheKey=t,this.usedTimes=1,this.program=_,this.vertexShader=T,this.fragmentShader=b,this}let $x=0;class Yx{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const n=t.vertexShader,i=t.fragmentShader,r=this._getShaderStage(n),s=this._getShaderStage(i),a=this._getShaderCacheForMaterial(t);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(t){const n=this.materialCache.get(t);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const n=this.materialCache;let i=n.get(t);return i===void 0&&(i=new Set,n.set(t,i)),i}_getShaderStage(t){const n=this.shaderCache;let i=n.get(t);return i===void 0&&(i=new qx(t),n.set(t,i)),i}}class qx{constructor(t){this.id=$x++,this.code=t,this.usedTimes=0}}function Kx(e){return e===Zr||e===ru||e===su}function Zx(e,t,n,i,r,s){const a=new L_,o=new Yx,l=new Set,u=[],f=new Map,h=i.logarithmicDepthBuffer;let c=i.precision;const p={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function m(S){return l.add(S),S===0?"uv":`uv${S}`}function _(S,x,P,R,N,U){const k=R.fog,L=N.geometry,z=S.isMeshStandardMaterial||S.isMeshLambertMaterial||S.isMeshPhongMaterial?R.environment:null,H=S.isMeshStandardMaterial||S.isMeshLambertMaterial&&!S.envMap||S.isMeshPhongMaterial&&!S.envMap,D=t.get(S.envMap||z,H),j=D&&D.mapping===Pu?D.image.height:null,J=p[S.type];S.precision!==null&&(c=i.getMaxPrecision(S.precision),c!==S.precision&&Ve("WebGLProgram.getParameters:",S.precision,"not supported, using",c,"instead."));const ae=L.morphAttributes.position||L.morphAttributes.normal||L.morphAttributes.color,de=ae!==void 0?ae.length:0;let Ne=0;L.morphAttributes.position!==void 0&&(Ne=1),L.morphAttributes.normal!==void 0&&(Ne=2),L.morphAttributes.color!==void 0&&(Ne=3);let Be,De,Q,ge;if(J){const je=li[J];Be=je.vertexShader,De=je.fragmentShader}else Be=S.vertexShader,De=S.fragmentShader,o.update(S),Q=o.getVertexShaderID(S),ge=o.getFragmentShaderID(S);const he=e.getRenderTarget(),Pe=e.state.buffers.depth.getReversed(),ze=N.isInstancedMesh===!0,Oe=N.isBatchedMesh===!0,nt=!!S.map,He=!!S.matcap,Qe=!!D,ut=!!S.aoMap,ve=!!S.lightMap,ot=!!S.bumpMap,Je=!!S.normalMap,Ge=!!S.displacementMap,F=!!S.emissiveMap,re=!!S.metalnessMap,oe=!!S.roughnessMap,le=S.anisotropy>0,K=S.clearcoat>0,pe=S.dispersion>0,C=S.iridescence>0,y=S.sheen>0,B=S.transmission>0,X=le&&!!S.anisotropyMap,se=K&&!!S.clearcoatMap,fe=K&&!!S.clearcoatNormalMap,_e=K&&!!S.clearcoatRoughnessMap,ee=C&&!!S.iridescenceMap,Z=C&&!!S.iridescenceThicknessMap,Me=y&&!!S.sheenColorMap,Ee=y&&!!S.sheenRoughnessMap,ie=!!S.specularMap,te=!!S.specularColorMap,ce=!!S.specularIntensityMap,Ie=B&&!!S.transmissionMap,$e=B&&!!S.thicknessMap,O=!!S.gradientMap,Se=!!S.alphaMap,ne=S.alphaTest>0,xe=!!S.alphaHash,ye=!!S.extensions;let ue=gi;S.toneMapped&&(he===null||he.isXRRenderTarget===!0)&&(ue=e.toneMapping);const Ue={shaderID:J,shaderType:S.type,shaderName:S.name,vertexShader:Be,fragmentShader:De,defines:S.defines,customVertexShaderID:Q,customFragmentShaderID:ge,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:c,batching:Oe,batchingColor:Oe&&N._colorsTexture!==null,instancing:ze,instancingColor:ze&&N.instanceColor!==null,instancingMorph:ze&&N.morphTexture!==null,outputColorSpace:he===null?e.outputColorSpace:he.isXRRenderTarget===!0?he.texture.colorSpace:et.workingColorSpace,alphaToCoverage:!!S.alphaToCoverage,map:nt,matcap:He,envMap:Qe,envMapMode:Qe&&D.mapping,envMapCubeUVHeight:j,aoMap:ut,lightMap:ve,bumpMap:ot,normalMap:Je,displacementMap:Ge,emissiveMap:F,normalMapObjectSpace:Je&&S.normalMapType===N2,normalMapTangentSpace:Je&&S.normalMapType===Pd,packedNormalMap:Je&&S.normalMapType===Pd&&Kx(S.normalMap.format),metalnessMap:re,roughnessMap:oe,anisotropy:le,anisotropyMap:X,clearcoat:K,clearcoatMap:se,clearcoatNormalMap:fe,clearcoatRoughnessMap:_e,dispersion:pe,iridescence:C,iridescenceMap:ee,iridescenceThicknessMap:Z,sheen:y,sheenColorMap:Me,sheenRoughnessMap:Ee,specularMap:ie,specularColorMap:te,specularIntensityMap:ce,transmission:B,transmissionMap:Ie,thicknessMap:$e,gradientMap:O,opaque:S.transparent===!1&&S.blending===Wr&&S.alphaToCoverage===!1,alphaMap:Se,alphaTest:ne,alphaHash:xe,combine:S.combine,mapUv:nt&&m(S.map.channel),aoMapUv:ut&&m(S.aoMap.channel),lightMapUv:ve&&m(S.lightMap.channel),bumpMapUv:ot&&m(S.bumpMap.channel),normalMapUv:Je&&m(S.normalMap.channel),displacementMapUv:Ge&&m(S.displacementMap.channel),emissiveMapUv:F&&m(S.emissiveMap.channel),metalnessMapUv:re&&m(S.metalnessMap.channel),roughnessMapUv:oe&&m(S.roughnessMap.channel),anisotropyMapUv:X&&m(S.anisotropyMap.channel),clearcoatMapUv:se&&m(S.clearcoatMap.channel),clearcoatNormalMapUv:fe&&m(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:_e&&m(S.clearcoatRoughnessMap.channel),iridescenceMapUv:ee&&m(S.iridescenceMap.channel),iridescenceThicknessMapUv:Z&&m(S.iridescenceThicknessMap.channel),sheenColorMapUv:Me&&m(S.sheenColorMap.channel),sheenRoughnessMapUv:Ee&&m(S.sheenRoughnessMap.channel),specularMapUv:ie&&m(S.specularMap.channel),specularColorMapUv:te&&m(S.specularColorMap.channel),specularIntensityMapUv:ce&&m(S.specularIntensityMap.channel),transmissionMapUv:Ie&&m(S.transmissionMap.channel),thicknessMapUv:$e&&m(S.thicknessMap.channel),alphaMapUv:Se&&m(S.alphaMap.channel),vertexTangents:!!L.attributes.tangent&&(Je||le),vertexNormals:!!L.attributes.normal,vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!L.attributes.color&&L.attributes.color.itemSize===4,pointsUvs:N.isPoints===!0&&!!L.attributes.uv&&(nt||Se),fog:!!k,useFog:S.fog===!0,fogExp2:!!k&&k.isFogExp2,flatShading:S.wireframe===!1&&(S.flatShading===!0||L.attributes.normal===void 0&&Je===!1&&(S.isMeshLambertMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isMeshPhysicalMaterial)),sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:h,reversedDepthBuffer:Pe,skinning:N.isSkinnedMesh===!0,morphTargets:L.morphAttributes.position!==void 0,morphNormals:L.morphAttributes.normal!==void 0,morphColors:L.morphAttributes.color!==void 0,morphTargetsCount:de,morphTextureStride:Ne,numDirLights:x.directional.length,numPointLights:x.point.length,numSpotLights:x.spot.length,numSpotLightMaps:x.spotLightMap.length,numRectAreaLights:x.rectArea.length,numHemiLights:x.hemi.length,numDirLightShadows:x.directionalShadowMap.length,numPointLightShadows:x.pointShadowMap.length,numSpotLightShadows:x.spotShadowMap.length,numSpotLightShadowsWithMaps:x.numSpotLightShadowsWithMaps,numLightProbes:x.numLightProbes,numLightProbeGrids:U.length,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:S.dithering,shadowMapEnabled:e.shadowMap.enabled&&P.length>0,shadowMapType:e.shadowMap.type,toneMapping:ue,decodeVideoTexture:nt&&S.map.isVideoTexture===!0&&et.getTransfer(S.map.colorSpace)===ft,decodeVideoTextureEmissive:F&&S.emissiveMap.isVideoTexture===!0&&et.getTransfer(S.emissiveMap.colorSpace)===ft,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===fi,flipSided:S.side===_n,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:ye&&S.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ye&&S.extensions.multiDraw===!0||Oe)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return Ue.vertexUv1s=l.has(1),Ue.vertexUv2s=l.has(2),Ue.vertexUv3s=l.has(3),l.clear(),Ue}function g(S){const x=[];if(S.shaderID?x.push(S.shaderID):(x.push(S.customVertexShaderID),x.push(S.customFragmentShaderID)),S.defines!==void 0)for(const P in S.defines)x.push(P),x.push(S.defines[P]);return S.isRawShaderMaterial===!1&&(d(x,S),v(x,S),x.push(e.outputColorSpace)),x.push(S.customProgramCacheKey),x.join()}function d(S,x){S.push(x.precision),S.push(x.outputColorSpace),S.push(x.envMapMode),S.push(x.envMapCubeUVHeight),S.push(x.mapUv),S.push(x.alphaMapUv),S.push(x.lightMapUv),S.push(x.aoMapUv),S.push(x.bumpMapUv),S.push(x.normalMapUv),S.push(x.displacementMapUv),S.push(x.emissiveMapUv),S.push(x.metalnessMapUv),S.push(x.roughnessMapUv),S.push(x.anisotropyMapUv),S.push(x.clearcoatMapUv),S.push(x.clearcoatNormalMapUv),S.push(x.clearcoatRoughnessMapUv),S.push(x.iridescenceMapUv),S.push(x.iridescenceThicknessMapUv),S.push(x.sheenColorMapUv),S.push(x.sheenRoughnessMapUv),S.push(x.specularMapUv),S.push(x.specularColorMapUv),S.push(x.specularIntensityMapUv),S.push(x.transmissionMapUv),S.push(x.thicknessMapUv),S.push(x.combine),S.push(x.fogExp2),S.push(x.sizeAttenuation),S.push(x.morphTargetsCount),S.push(x.morphAttributeCount),S.push(x.numDirLights),S.push(x.numPointLights),S.push(x.numSpotLights),S.push(x.numSpotLightMaps),S.push(x.numHemiLights),S.push(x.numRectAreaLights),S.push(x.numDirLightShadows),S.push(x.numPointLightShadows),S.push(x.numSpotLightShadows),S.push(x.numSpotLightShadowsWithMaps),S.push(x.numLightProbes),S.push(x.shadowMapType),S.push(x.toneMapping),S.push(x.numClippingPlanes),S.push(x.numClipIntersection),S.push(x.depthPacking)}function v(S,x){a.disableAll(),x.instancing&&a.enable(0),x.instancingColor&&a.enable(1),x.instancingMorph&&a.enable(2),x.matcap&&a.enable(3),x.envMap&&a.enable(4),x.normalMapObjectSpace&&a.enable(5),x.normalMapTangentSpace&&a.enable(6),x.clearcoat&&a.enable(7),x.iridescence&&a.enable(8),x.alphaTest&&a.enable(9),x.vertexColors&&a.enable(10),x.vertexAlphas&&a.enable(11),x.vertexUv1s&&a.enable(12),x.vertexUv2s&&a.enable(13),x.vertexUv3s&&a.enable(14),x.vertexTangents&&a.enable(15),x.anisotropy&&a.enable(16),x.alphaHash&&a.enable(17),x.batching&&a.enable(18),x.dispersion&&a.enable(19),x.batchingColor&&a.enable(20),x.gradientMap&&a.enable(21),x.packedNormalMap&&a.enable(22),x.vertexNormals&&a.enable(23),S.push(a.mask),a.disableAll(),x.fog&&a.enable(0),x.useFog&&a.enable(1),x.flatShading&&a.enable(2),x.logarithmicDepthBuffer&&a.enable(3),x.reversedDepthBuffer&&a.enable(4),x.skinning&&a.enable(5),x.morphTargets&&a.enable(6),x.morphNormals&&a.enable(7),x.morphColors&&a.enable(8),x.premultipliedAlpha&&a.enable(9),x.shadowMapEnabled&&a.enable(10),x.doubleSided&&a.enable(11),x.flipSided&&a.enable(12),x.useDepthPacking&&a.enable(13),x.dithering&&a.enable(14),x.transmission&&a.enable(15),x.sheen&&a.enable(16),x.opaque&&a.enable(17),x.pointsUvs&&a.enable(18),x.decodeVideoTexture&&a.enable(19),x.decodeVideoTextureEmissive&&a.enable(20),x.alphaToCoverage&&a.enable(21),x.numLightProbeGrids>0&&a.enable(22),S.push(a.mask)}function M(S){const x=p[S.type];let P;if(x){const R=li[x];P=vE.clone(R.uniforms)}else P=S.uniforms;return P}function E(S,x){let P=f.get(x);return P!==void 0?++P.usedTimes:(P=new Xx(e,x,S,r),u.push(P),f.set(x,P)),P}function T(S){if(--S.usedTimes===0){const x=u.indexOf(S);u[x]=u[u.length-1],u.pop(),f.delete(S.cacheKey),S.destroy()}}function b(S){o.remove(S)}function w(){o.dispose()}return{getParameters:_,getProgramCacheKey:g,getUniforms:M,acquireProgram:E,releaseProgram:T,releaseShaderCache:b,programs:u,dispose:w}}function Qx(){let e=new WeakMap;function t(a){return e.has(a)}function n(a){let o=e.get(a);return o===void 0&&(o={},e.set(a,o)),o}function i(a){e.delete(a)}function r(a,o,l){e.get(a)[o]=l}function s(){e=new WeakMap}return{has:t,get:n,remove:i,update:r,dispose:s}}function Jx(e,t){return e.groupOrder!==t.groupOrder?e.groupOrder-t.groupOrder:e.renderOrder!==t.renderOrder?e.renderOrder-t.renderOrder:e.material.id!==t.material.id?e.material.id-t.material.id:e.materialVariant!==t.materialVariant?e.materialVariant-t.materialVariant:e.z!==t.z?e.z-t.z:e.id-t.id}function Wm(e,t){return e.groupOrder!==t.groupOrder?e.groupOrder-t.groupOrder:e.renderOrder!==t.renderOrder?e.renderOrder-t.renderOrder:e.z!==t.z?t.z-e.z:e.id-t.id}function jm(){const e=[];let t=0;const n=[],i=[],r=[];function s(){t=0,n.length=0,i.length=0,r.length=0}function a(c){let p=0;return c.isInstancedMesh&&(p+=2),c.isSkinnedMesh&&(p+=1),p}function o(c,p,m,_,g,d){let v=e[t];return v===void 0?(v={id:c.id,object:c,geometry:p,material:m,materialVariant:a(c),groupOrder:_,renderOrder:c.renderOrder,z:g,group:d},e[t]=v):(v.id=c.id,v.object=c,v.geometry=p,v.material=m,v.materialVariant=a(c),v.groupOrder=_,v.renderOrder=c.renderOrder,v.z=g,v.group=d),t++,v}function l(c,p,m,_,g,d){const v=o(c,p,m,_,g,d);m.transmission>0?i.push(v):m.transparent===!0?r.push(v):n.push(v)}function u(c,p,m,_,g,d){const v=o(c,p,m,_,g,d);m.transmission>0?i.unshift(v):m.transparent===!0?r.unshift(v):n.unshift(v)}function f(c,p){n.length>1&&n.sort(c||Jx),i.length>1&&i.sort(p||Wm),r.length>1&&r.sort(p||Wm)}function h(){for(let c=t,p=e.length;c<p;c++){const m=e[c];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:n,transmissive:i,transparent:r,init:s,push:l,unshift:u,finish:h,sort:f}}function eA(){let e=new WeakMap;function t(i,r){const s=e.get(i);let a;return s===void 0?(a=new jm,e.set(i,[a])):r>=s.length?(a=new jm,s.push(a)):a=s[r],a}function n(){e=new WeakMap}return{get:t,dispose:n}}function tA(){const e={};return{get:function(t){if(e[t.id]!==void 0)return e[t.id];let n;switch(t.type){case"DirectionalLight":n={direction:new V,color:new qe};break;case"SpotLight":n={position:new V,direction:new V,color:new qe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new V,color:new qe,distance:0,decay:0};break;case"HemisphereLight":n={direction:new V,skyColor:new qe,groundColor:new qe};break;case"RectAreaLight":n={color:new qe,position:new V,halfWidth:new V,halfHeight:new V};break}return e[t.id]=n,n}}}function nA(){const e={};return{get:function(t){if(e[t.id]!==void 0)return e[t.id];let n;switch(t.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new lt};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new lt};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new lt,shadowCameraNear:1,shadowCameraFar:1e3};break}return e[t.id]=n,n}}}let iA=0;function rA(e,t){return(t.castShadow?2:0)-(e.castShadow?2:0)+(t.map?1:0)-(e.map?1:0)}function sA(e){const t=new tA,n=nA(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let u=0;u<9;u++)i.probe.push(new V);const r=new V,s=new wt,a=new wt;function o(u){let f=0,h=0,c=0;for(let x=0;x<9;x++)i.probe[x].set(0,0,0);let p=0,m=0,_=0,g=0,d=0,v=0,M=0,E=0,T=0,b=0,w=0;u.sort(rA);for(let x=0,P=u.length;x<P;x++){const R=u[x],N=R.color,U=R.intensity,k=R.distance;let L=null;if(R.shadow&&R.shadow.map&&(R.shadow.map.texture.format===Zr?L=R.shadow.map.texture:L=R.shadow.map.depthTexture||R.shadow.map.texture),R.isAmbientLight)f+=N.r*U,h+=N.g*U,c+=N.b*U;else if(R.isLightProbe){for(let z=0;z<9;z++)i.probe[z].addScaledVector(R.sh.coefficients[z],U);w++}else if(R.isDirectionalLight){const z=t.get(R);if(z.color.copy(R.color).multiplyScalar(R.intensity),R.castShadow){const H=R.shadow,D=n.get(R);D.shadowIntensity=H.intensity,D.shadowBias=H.bias,D.shadowNormalBias=H.normalBias,D.shadowRadius=H.radius,D.shadowMapSize=H.mapSize,i.directionalShadow[p]=D,i.directionalShadowMap[p]=L,i.directionalShadowMatrix[p]=R.shadow.matrix,v++}i.directional[p]=z,p++}else if(R.isSpotLight){const z=t.get(R);z.position.setFromMatrixPosition(R.matrixWorld),z.color.copy(N).multiplyScalar(U),z.distance=k,z.coneCos=Math.cos(R.angle),z.penumbraCos=Math.cos(R.angle*(1-R.penumbra)),z.decay=R.decay,i.spot[_]=z;const H=R.shadow;if(R.map&&(i.spotLightMap[T]=R.map,T++,H.updateMatrices(R),R.castShadow&&b++),i.spotLightMatrix[_]=H.matrix,R.castShadow){const D=n.get(R);D.shadowIntensity=H.intensity,D.shadowBias=H.bias,D.shadowNormalBias=H.normalBias,D.shadowRadius=H.radius,D.shadowMapSize=H.mapSize,i.spotShadow[_]=D,i.spotShadowMap[_]=L,E++}_++}else if(R.isRectAreaLight){const z=t.get(R);z.color.copy(N).multiplyScalar(U),z.halfWidth.set(R.width*.5,0,0),z.halfHeight.set(0,R.height*.5,0),i.rectArea[g]=z,g++}else if(R.isPointLight){const z=t.get(R);if(z.color.copy(R.color).multiplyScalar(R.intensity),z.distance=R.distance,z.decay=R.decay,R.castShadow){const H=R.shadow,D=n.get(R);D.shadowIntensity=H.intensity,D.shadowBias=H.bias,D.shadowNormalBias=H.normalBias,D.shadowRadius=H.radius,D.shadowMapSize=H.mapSize,D.shadowCameraNear=H.camera.near,D.shadowCameraFar=H.camera.far,i.pointShadow[m]=D,i.pointShadowMap[m]=L,i.pointShadowMatrix[m]=R.shadow.matrix,M++}i.point[m]=z,m++}else if(R.isHemisphereLight){const z=t.get(R);z.skyColor.copy(R.color).multiplyScalar(U),z.groundColor.copy(R.groundColor).multiplyScalar(U),i.hemi[d]=z,d++}}g>0&&(e.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=Te.LTC_FLOAT_1,i.rectAreaLTC2=Te.LTC_FLOAT_2):(i.rectAreaLTC1=Te.LTC_HALF_1,i.rectAreaLTC2=Te.LTC_HALF_2)),i.ambient[0]=f,i.ambient[1]=h,i.ambient[2]=c;const S=i.hash;(S.directionalLength!==p||S.pointLength!==m||S.spotLength!==_||S.rectAreaLength!==g||S.hemiLength!==d||S.numDirectionalShadows!==v||S.numPointShadows!==M||S.numSpotShadows!==E||S.numSpotMaps!==T||S.numLightProbes!==w)&&(i.directional.length=p,i.spot.length=_,i.rectArea.length=g,i.point.length=m,i.hemi.length=d,i.directionalShadow.length=v,i.directionalShadowMap.length=v,i.pointShadow.length=M,i.pointShadowMap.length=M,i.spotShadow.length=E,i.spotShadowMap.length=E,i.directionalShadowMatrix.length=v,i.pointShadowMatrix.length=M,i.spotLightMatrix.length=E+T-b,i.spotLightMap.length=T,i.numSpotLightShadowsWithMaps=b,i.numLightProbes=w,S.directionalLength=p,S.pointLength=m,S.spotLength=_,S.rectAreaLength=g,S.hemiLength=d,S.numDirectionalShadows=v,S.numPointShadows=M,S.numSpotShadows=E,S.numSpotMaps=T,S.numLightProbes=w,i.version=iA++)}function l(u,f){let h=0,c=0,p=0,m=0,_=0;const g=f.matrixWorldInverse;for(let d=0,v=u.length;d<v;d++){const M=u[d];if(M.isDirectionalLight){const E=i.directional[h];E.direction.setFromMatrixPosition(M.matrixWorld),r.setFromMatrixPosition(M.target.matrixWorld),E.direction.sub(r),E.direction.transformDirection(g),h++}else if(M.isSpotLight){const E=i.spot[p];E.position.setFromMatrixPosition(M.matrixWorld),E.position.applyMatrix4(g),E.direction.setFromMatrixPosition(M.matrixWorld),r.setFromMatrixPosition(M.target.matrixWorld),E.direction.sub(r),E.direction.transformDirection(g),p++}else if(M.isRectAreaLight){const E=i.rectArea[m];E.position.setFromMatrixPosition(M.matrixWorld),E.position.applyMatrix4(g),a.identity(),s.copy(M.matrixWorld),s.premultiply(g),a.extractRotation(s),E.halfWidth.set(M.width*.5,0,0),E.halfHeight.set(0,M.height*.5,0),E.halfWidth.applyMatrix4(a),E.halfHeight.applyMatrix4(a),m++}else if(M.isPointLight){const E=i.point[c];E.position.setFromMatrixPosition(M.matrixWorld),E.position.applyMatrix4(g),c++}else if(M.isHemisphereLight){const E=i.hemi[_];E.direction.setFromMatrixPosition(M.matrixWorld),E.direction.transformDirection(g),_++}}}return{setup:o,setupView:l,state:i}}function Xm(e){const t=new sA(e),n=[],i=[],r=[];function s(c){h.camera=c,n.length=0,i.length=0,r.length=0}function a(c){n.push(c)}function o(c){i.push(c)}function l(c){r.push(c)}function u(){t.setup(n)}function f(c){t.setupView(n,c)}const h={lightsArray:n,shadowsArray:i,lightProbeGridArray:r,camera:null,lights:t,transmissionRenderTarget:{},textureUnits:0};return{init:s,state:h,setupLights:u,setupLightsView:f,pushLight:a,pushShadow:o,pushLightProbeGrid:l}}function aA(e){let t=new WeakMap;function n(r,s=0){const a=t.get(r);let o;return a===void 0?(o=new Xm(e),t.set(r,[o])):s>=a.length?(o=new Xm(e),a.push(o)):o=a[s],o}function i(){t=new WeakMap}return{get:n,dispose:i}}const oA=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,uA=[new V(1,0,0),new V(-1,0,0),new V(0,1,0),new V(0,-1,0),new V(0,0,1),new V(0,0,-1)],cA=[new V(0,-1,0),new V(0,-1,0),new V(0,0,1),new V(0,0,-1),new V(0,-1,0),new V(0,-1,0)],$m=new wt,va=new V,Wc=new V;function fA(e,t,n){let i=new ep;const r=new lt,s=new lt,a=new Rt,o=new ME,l=new EE,u={},f=n.maxTextureSize,h={[_i]:_n,[_n]:_i,[fi]:fi},c=new Gn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new lt},radius:{value:4}},vertexShader:oA,fragmentShader:lA}),p=c.clone();p.defines.HORIZONTAL_PASS=1;const m=new cn;m.setAttribute("position",new kn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new ct(m,c),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=wl;let d=this.type;this.render=function(b,w,S){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||b.length===0)return;this.type===u2&&(Ve("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=wl);const x=e.getRenderTarget(),P=e.getActiveCubeFace(),R=e.getActiveMipmapLevel(),N=e.state;N.setBlending(Ui),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const U=d!==this.type;U&&w.traverse(function(k){k.material&&(Array.isArray(k.material)?k.material.forEach(L=>L.needsUpdate=!0):k.material.needsUpdate=!0)});for(let k=0,L=b.length;k<L;k++){const z=b[k],H=z.shadow;if(H===void 0){Ve("WebGLShadowMap:",z,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;r.copy(H.mapSize);const D=H.getFrameExtents();r.multiply(D),s.copy(H.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/D.x),r.x=s.x*D.x,H.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/D.y),r.y=s.y*D.y,H.mapSize.y=s.y));const j=e.state.buffers.depth.getReversed();if(H.camera._reversedDepth=j,H.map===null||U===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===ba){if(z.isPointLight){Ve("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new vi(r.x,r.y,{format:Zr,type:Gi,minFilter:en,magFilter:en,generateMipmaps:!1}),H.map.texture.name=z.name+".shadowMap",H.map.depthTexture=new Ys(r.x,r.y,di),H.map.depthTexture.name=z.name+".shadowMapDepth",H.map.depthTexture.format=Vi,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=jt,H.map.depthTexture.magFilter=jt}else z.isPointLight?(H.map=new X_(r.x),H.map.depthTexture=new mE(r.x,Si)):(H.map=new vi(r.x,r.y),H.map.depthTexture=new Ys(r.x,r.y,Si)),H.map.depthTexture.name=z.name+".shadowMap",H.map.depthTexture.format=Vi,this.type===wl?(H.map.depthTexture.compareFunction=j?Kh:qh,H.map.depthTexture.minFilter=en,H.map.depthTexture.magFilter=en):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=jt,H.map.depthTexture.magFilter=jt);H.camera.updateProjectionMatrix()}const J=H.map.isWebGLCubeRenderTarget?6:1;for(let ae=0;ae<J;ae++){if(H.map.isWebGLCubeRenderTarget)e.setRenderTarget(H.map,ae),e.clear();else{ae===0&&(e.setRenderTarget(H.map),e.clear());const de=H.getViewport(ae);a.set(s.x*de.x,s.y*de.y,s.x*de.z,s.y*de.w),N.viewport(a)}if(z.isPointLight){const de=H.camera,Ne=H.matrix,Be=z.distance||de.far;Be!==de.far&&(de.far=Be,de.updateProjectionMatrix()),va.setFromMatrixPosition(z.matrixWorld),de.position.copy(va),Wc.copy(de.position),Wc.add(uA[ae]),de.up.copy(cA[ae]),de.lookAt(Wc),de.updateMatrixWorld(),Ne.makeTranslation(-va.x,-va.y,-va.z),$m.multiplyMatrices(de.projectionMatrix,de.matrixWorldInverse),H._frustum.setFromProjectionMatrix($m,de.coordinateSystem,de.reversedDepth)}else H.updateMatrices(z);i=H.getFrustum(),E(w,S,H.camera,z,this.type)}H.isPointLightShadow!==!0&&this.type===ba&&v(H,S),H.needsUpdate=!1}d=this.type,g.needsUpdate=!1,e.setRenderTarget(x,P,R)};function v(b,w){const S=t.update(_);c.defines.VSM_SAMPLES!==b.blurSamples&&(c.defines.VSM_SAMPLES=b.blurSamples,p.defines.VSM_SAMPLES=b.blurSamples,c.needsUpdate=!0,p.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new vi(r.x,r.y,{format:Zr,type:Gi})),c.uniforms.shadow_pass.value=b.map.depthTexture,c.uniforms.resolution.value=b.mapSize,c.uniforms.radius.value=b.radius,e.setRenderTarget(b.mapPass),e.clear(),e.renderBufferDirect(w,null,S,c,_,null),p.uniforms.shadow_pass.value=b.mapPass.texture,p.uniforms.resolution.value=b.mapSize,p.uniforms.radius.value=b.radius,e.setRenderTarget(b.map),e.clear(),e.renderBufferDirect(w,null,S,p,_,null)}function M(b,w,S,x){let P=null;const R=S.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(R!==void 0)P=R;else if(P=S.isPointLight===!0?l:o,e.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const N=P.uuid,U=w.uuid;let k=u[N];k===void 0&&(k={},u[N]=k);let L=k[U];L===void 0&&(L=P.clone(),k[U]=L,w.addEventListener("dispose",T)),P=L}if(P.visible=w.visible,P.wireframe=w.wireframe,x===ba?P.side=w.shadowSide!==null?w.shadowSide:w.side:P.side=w.shadowSide!==null?w.shadowSide:h[w.side],P.alphaMap=w.alphaMap,P.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,P.map=w.map,P.clipShadows=w.clipShadows,P.clippingPlanes=w.clippingPlanes,P.clipIntersection=w.clipIntersection,P.displacementMap=w.displacementMap,P.displacementScale=w.displacementScale,P.displacementBias=w.displacementBias,P.wireframeLinewidth=w.wireframeLinewidth,P.linewidth=w.linewidth,S.isPointLight===!0&&P.isMeshDistanceMaterial===!0){const N=e.properties.get(P);N.light=S}return P}function E(b,w,S,x,P){if(b.visible===!1)return;if(b.layers.test(w.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&P===ba)&&(!b.frustumCulled||i.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(S.matrixWorldInverse,b.matrixWorld);const U=t.update(b),k=b.material;if(Array.isArray(k)){const L=U.groups;for(let z=0,H=L.length;z<H;z++){const D=L[z],j=k[D.materialIndex];if(j&&j.visible){const J=M(b,j,x,P);b.onBeforeShadow(e,b,w,S,U,J,D),e.renderBufferDirect(S,null,U,J,b,D),b.onAfterShadow(e,b,w,S,U,J,D)}}}else if(k.visible){const L=M(b,k,x,P);b.onBeforeShadow(e,b,w,S,U,L,null),e.renderBufferDirect(S,null,U,L,b,null),b.onAfterShadow(e,b,w,S,U,L,null)}}const N=b.children;for(let U=0,k=N.length;U<k;U++)E(N[U],w,S,x,P)}function T(b){b.target.removeEventListener("dispose",T);for(const S in u){const x=u[S],P=b.target.uuid;P in x&&(x[P].dispose(),delete x[P])}}}function dA(e,t){function n(){let O=!1;const Se=new Rt;let ne=null;const xe=new Rt(0,0,0,0);return{setMask:function(ye){ne!==ye&&!O&&(e.colorMask(ye,ye,ye,ye),ne=ye)},setLocked:function(ye){O=ye},setClear:function(ye,ue,Ue,je,Pt){Pt===!0&&(ye*=je,ue*=je,Ue*=je),Se.set(ye,ue,Ue,je),xe.equals(Se)===!1&&(e.clearColor(ye,ue,Ue,je),xe.copy(Se))},reset:function(){O=!1,ne=null,xe.set(-1,0,0,0)}}}function i(){let O=!1,Se=!1,ne=null,xe=null,ye=null;return{setReversed:function(ue){if(Se!==ue){const Ue=t.get("EXT_clip_control");ue?Ue.clipControlEXT(Ue.LOWER_LEFT_EXT,Ue.ZERO_TO_ONE_EXT):Ue.clipControlEXT(Ue.LOWER_LEFT_EXT,Ue.NEGATIVE_ONE_TO_ONE_EXT),Se=ue;const je=ye;ye=null,this.setClear(je)}},getReversed:function(){return Se},setTest:function(ue){ue?he(e.DEPTH_TEST):Pe(e.DEPTH_TEST)},setMask:function(ue){ne!==ue&&!O&&(e.depthMask(ue),ne=ue)},setFunc:function(ue){if(Se&&(ue=V2[ue]),xe!==ue){switch(ue){case jf:e.depthFunc(e.NEVER);break;case Xf:e.depthFunc(e.ALWAYS);break;case $f:e.depthFunc(e.LESS);break;case Xs:e.depthFunc(e.LEQUAL);break;case Yf:e.depthFunc(e.EQUAL);break;case qf:e.depthFunc(e.GEQUAL);break;case Kf:e.depthFunc(e.GREATER);break;case Zf:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}xe=ue}},setLocked:function(ue){O=ue},setClear:function(ue){ye!==ue&&(ye=ue,Se&&(ue=1-ue),e.clearDepth(ue))},reset:function(){O=!1,ne=null,xe=null,ye=null,Se=!1}}}function r(){let O=!1,Se=null,ne=null,xe=null,ye=null,ue=null,Ue=null,je=null,Pt=null;return{setTest:function(ht){O||(ht?he(e.STENCIL_TEST):Pe(e.STENCIL_TEST))},setMask:function(ht){Se!==ht&&!O&&(e.stencilMask(ht),Se=ht)},setFunc:function(ht,Mi,ti){(ne!==ht||xe!==Mi||ye!==ti)&&(e.stencilFunc(ht,Mi,ti),ne=ht,xe=Mi,ye=ti)},setOp:function(ht,Mi,ti){(ue!==ht||Ue!==Mi||je!==ti)&&(e.stencilOp(ht,Mi,ti),ue=ht,Ue=Mi,je=ti)},setLocked:function(ht){O=ht},setClear:function(ht){Pt!==ht&&(e.clearStencil(ht),Pt=ht)},reset:function(){O=!1,Se=null,ne=null,xe=null,ye=null,ue=null,Ue=null,je=null,Pt=null}}}const s=new n,a=new i,o=new r,l=new WeakMap,u=new WeakMap;let f={},h={},c={},p=new WeakMap,m=[],_=null,g=!1,d=null,v=null,M=null,E=null,T=null,b=null,w=null,S=new qe(0,0,0),x=0,P=!1,R=null,N=null,U=null,k=null,L=null;const z=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,D=0;const j=e.getParameter(e.VERSION);j.indexOf("WebGL")!==-1?(D=parseFloat(/^WebGL (\d)/.exec(j)[1]),H=D>=1):j.indexOf("OpenGL ES")!==-1&&(D=parseFloat(/^OpenGL ES (\d)/.exec(j)[1]),H=D>=2);let J=null,ae={};const de=e.getParameter(e.SCISSOR_BOX),Ne=e.getParameter(e.VIEWPORT),Be=new Rt().fromArray(de),De=new Rt().fromArray(Ne);function Q(O,Se,ne,xe){const ye=new Uint8Array(4),ue=e.createTexture();e.bindTexture(O,ue),e.texParameteri(O,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(O,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let Ue=0;Ue<ne;Ue++)O===e.TEXTURE_3D||O===e.TEXTURE_2D_ARRAY?e.texImage3D(Se,0,e.RGBA,1,1,xe,0,e.RGBA,e.UNSIGNED_BYTE,ye):e.texImage2D(Se+Ue,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,ye);return ue}const ge={};ge[e.TEXTURE_2D]=Q(e.TEXTURE_2D,e.TEXTURE_2D,1),ge[e.TEXTURE_CUBE_MAP]=Q(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),ge[e.TEXTURE_2D_ARRAY]=Q(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),ge[e.TEXTURE_3D]=Q(e.TEXTURE_3D,e.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),he(e.DEPTH_TEST),a.setFunc(Xs),ot(!1),Je(W0),he(e.CULL_FACE),ut(Ui);function he(O){f[O]!==!0&&(e.enable(O),f[O]=!0)}function Pe(O){f[O]!==!1&&(e.disable(O),f[O]=!1)}function ze(O,Se){return c[O]!==Se?(e.bindFramebuffer(O,Se),c[O]=Se,O===e.DRAW_FRAMEBUFFER&&(c[e.FRAMEBUFFER]=Se),O===e.FRAMEBUFFER&&(c[e.DRAW_FRAMEBUFFER]=Se),!0):!1}function Oe(O,Se){let ne=m,xe=!1;if(O){ne=p.get(Se),ne===void 0&&(ne=[],p.set(Se,ne));const ye=O.textures;if(ne.length!==ye.length||ne[0]!==e.COLOR_ATTACHMENT0){for(let ue=0,Ue=ye.length;ue<Ue;ue++)ne[ue]=e.COLOR_ATTACHMENT0+ue;ne.length=ye.length,xe=!0}}else ne[0]!==e.BACK&&(ne[0]=e.BACK,xe=!0);xe&&e.drawBuffers(ne)}function nt(O){return _!==O?(e.useProgram(O),_=O,!0):!1}const He={[Dr]:e.FUNC_ADD,[f2]:e.FUNC_SUBTRACT,[d2]:e.FUNC_REVERSE_SUBTRACT};He[h2]=e.MIN,He[p2]=e.MAX;const Qe={[m2]:e.ZERO,[g2]:e.ONE,[v2]:e.SRC_COLOR,[Hf]:e.SRC_ALPHA,[T2]:e.SRC_ALPHA_SATURATE,[M2]:e.DST_COLOR,[S2]:e.DST_ALPHA,[_2]:e.ONE_MINUS_SRC_COLOR,[Wf]:e.ONE_MINUS_SRC_ALPHA,[E2]:e.ONE_MINUS_DST_COLOR,[y2]:e.ONE_MINUS_DST_ALPHA,[b2]:e.CONSTANT_COLOR,[w2]:e.ONE_MINUS_CONSTANT_COLOR,[x2]:e.CONSTANT_ALPHA,[A2]:e.ONE_MINUS_CONSTANT_ALPHA};function ut(O,Se,ne,xe,ye,ue,Ue,je,Pt,ht){if(O===Ui){g===!0&&(Pe(e.BLEND),g=!1);return}if(g===!1&&(he(e.BLEND),g=!0),O!==c2){if(O!==d||ht!==P){if((v!==Dr||T!==Dr)&&(e.blendEquation(e.FUNC_ADD),v=Dr,T=Dr),ht)switch(O){case Wr:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case iu:e.blendFunc(e.ONE,e.ONE);break;case j0:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case X0:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:st("WebGLState: Invalid blending: ",O);break}else switch(O){case Wr:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case iu:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case j0:st("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case X0:st("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:st("WebGLState: Invalid blending: ",O);break}M=null,E=null,b=null,w=null,S.set(0,0,0),x=0,d=O,P=ht}return}ye=ye||Se,ue=ue||ne,Ue=Ue||xe,(Se!==v||ye!==T)&&(e.blendEquationSeparate(He[Se],He[ye]),v=Se,T=ye),(ne!==M||xe!==E||ue!==b||Ue!==w)&&(e.blendFuncSeparate(Qe[ne],Qe[xe],Qe[ue],Qe[Ue]),M=ne,E=xe,b=ue,w=Ue),(je.equals(S)===!1||Pt!==x)&&(e.blendColor(je.r,je.g,je.b,Pt),S.copy(je),x=Pt),d=O,P=!1}function ve(O,Se){O.side===fi?Pe(e.CULL_FACE):he(e.CULL_FACE);let ne=O.side===_n;Se&&(ne=!ne),ot(ne),O.blending===Wr&&O.transparent===!1?ut(Ui):ut(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),a.setFunc(O.depthFunc),a.setTest(O.depthTest),a.setMask(O.depthWrite),s.setMask(O.colorWrite);const xe=O.stencilWrite;o.setTest(xe),xe&&(o.setMask(O.stencilWriteMask),o.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),o.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),F(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?he(e.SAMPLE_ALPHA_TO_COVERAGE):Pe(e.SAMPLE_ALPHA_TO_COVERAGE)}function ot(O){R!==O&&(O?e.frontFace(e.CW):e.frontFace(e.CCW),R=O)}function Je(O){O!==o2?(he(e.CULL_FACE),O!==N&&(O===W0?e.cullFace(e.BACK):O===l2?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):Pe(e.CULL_FACE),N=O}function Ge(O){O!==U&&(H&&e.lineWidth(O),U=O)}function F(O,Se,ne){O?(he(e.POLYGON_OFFSET_FILL),(k!==Se||L!==ne)&&(k=Se,L=ne,a.getReversed()&&(Se=-Se),e.polygonOffset(Se,ne))):Pe(e.POLYGON_OFFSET_FILL)}function re(O){O?he(e.SCISSOR_TEST):Pe(e.SCISSOR_TEST)}function oe(O){O===void 0&&(O=e.TEXTURE0+z-1),J!==O&&(e.activeTexture(O),J=O)}function le(O,Se,ne){ne===void 0&&(J===null?ne=e.TEXTURE0+z-1:ne=J);let xe=ae[ne];xe===void 0&&(xe={type:void 0,texture:void 0},ae[ne]=xe),(xe.type!==O||xe.texture!==Se)&&(J!==ne&&(e.activeTexture(ne),J=ne),e.bindTexture(O,Se||ge[O]),xe.type=O,xe.texture=Se)}function K(){const O=ae[J];O!==void 0&&O.type!==void 0&&(e.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function pe(){try{e.compressedTexImage2D(...arguments)}catch(O){st("WebGLState:",O)}}function C(){try{e.compressedTexImage3D(...arguments)}catch(O){st("WebGLState:",O)}}function y(){try{e.texSubImage2D(...arguments)}catch(O){st("WebGLState:",O)}}function B(){try{e.texSubImage3D(...arguments)}catch(O){st("WebGLState:",O)}}function X(){try{e.compressedTexSubImage2D(...arguments)}catch(O){st("WebGLState:",O)}}function se(){try{e.compressedTexSubImage3D(...arguments)}catch(O){st("WebGLState:",O)}}function fe(){try{e.texStorage2D(...arguments)}catch(O){st("WebGLState:",O)}}function _e(){try{e.texStorage3D(...arguments)}catch(O){st("WebGLState:",O)}}function ee(){try{e.texImage2D(...arguments)}catch(O){st("WebGLState:",O)}}function Z(){try{e.texImage3D(...arguments)}catch(O){st("WebGLState:",O)}}function Me(O){return h[O]!==void 0?h[O]:e.getParameter(O)}function Ee(O,Se){h[O]!==Se&&(e.pixelStorei(O,Se),h[O]=Se)}function ie(O){Be.equals(O)===!1&&(e.scissor(O.x,O.y,O.z,O.w),Be.copy(O))}function te(O){De.equals(O)===!1&&(e.viewport(O.x,O.y,O.z,O.w),De.copy(O))}function ce(O,Se){let ne=u.get(Se);ne===void 0&&(ne=new WeakMap,u.set(Se,ne));let xe=ne.get(O);xe===void 0&&(xe=e.getUniformBlockIndex(Se,O.name),ne.set(O,xe))}function Ie(O,Se){const xe=u.get(Se).get(O);l.get(Se)!==xe&&(e.uniformBlockBinding(Se,xe,O.__bindingPointIndex),l.set(Se,xe))}function $e(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),a.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),e.pixelStorei(e.PACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!1),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,e.BROWSER_DEFAULT_WEBGL),e.pixelStorei(e.PACK_ROW_LENGTH,0),e.pixelStorei(e.PACK_SKIP_PIXELS,0),e.pixelStorei(e.PACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_ROW_LENGTH,0),e.pixelStorei(e.UNPACK_IMAGE_HEIGHT,0),e.pixelStorei(e.UNPACK_SKIP_PIXELS,0),e.pixelStorei(e.UNPACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_SKIP_IMAGES,0),f={},h={},J=null,ae={},c={},p=new WeakMap,m=[],_=null,g=!1,d=null,v=null,M=null,E=null,T=null,b=null,w=null,S=new qe(0,0,0),x=0,P=!1,R=null,N=null,U=null,k=null,L=null,Be.set(0,0,e.canvas.width,e.canvas.height),De.set(0,0,e.canvas.width,e.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:he,disable:Pe,bindFramebuffer:ze,drawBuffers:Oe,useProgram:nt,setBlending:ut,setMaterial:ve,setFlipSided:ot,setCullFace:Je,setLineWidth:Ge,setPolygonOffset:F,setScissorTest:re,activeTexture:oe,bindTexture:le,unbindTexture:K,compressedTexImage2D:pe,compressedTexImage3D:C,texImage2D:ee,texImage3D:Z,pixelStorei:Ee,getParameter:Me,updateUBOMapping:ce,uniformBlockBinding:Ie,texStorage2D:fe,texStorage3D:_e,texSubImage2D:y,texSubImage3D:B,compressedTexSubImage2D:X,compressedTexSubImage3D:se,scissor:ie,viewport:te,reset:$e}}function hA(e,t,n,i,r,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new lt,f=new WeakMap,h=new Set;let c;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(C,y){return m?new OffscreenCanvas(C,y):lu("canvas")}function g(C,y,B){let X=1;const se=pe(C);if((se.width>B||se.height>B)&&(X=B/Math.max(se.width,se.height)),X<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const fe=Math.floor(X*se.width),_e=Math.floor(X*se.height);c===void 0&&(c=_(fe,_e));const ee=y?_(fe,_e):c;return ee.width=fe,ee.height=_e,ee.getContext("2d").drawImage(C,0,0,fe,_e),Ve("WebGLRenderer: Texture has been resized from ("+se.width+"x"+se.height+") to ("+fe+"x"+_e+")."),ee}else return"data"in C&&Ve("WebGLRenderer: Image in DataTexture is too big ("+se.width+"x"+se.height+")."),C;return C}function d(C){return C.generateMipmaps}function v(C){e.generateMipmap(C)}function M(C){return C.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?e.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function E(C,y,B,X,se,fe=!1){if(C!==null){if(e[C]!==void 0)return e[C];Ve("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let _e;X&&(_e=t.get("EXT_texture_norm16"),_e||Ve("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let ee=y;if(y===e.RED&&(B===e.FLOAT&&(ee=e.R32F),B===e.HALF_FLOAT&&(ee=e.R16F),B===e.UNSIGNED_BYTE&&(ee=e.R8),B===e.UNSIGNED_SHORT&&_e&&(ee=_e.R16_EXT),B===e.SHORT&&_e&&(ee=_e.R16_SNORM_EXT)),y===e.RED_INTEGER&&(B===e.UNSIGNED_BYTE&&(ee=e.R8UI),B===e.UNSIGNED_SHORT&&(ee=e.R16UI),B===e.UNSIGNED_INT&&(ee=e.R32UI),B===e.BYTE&&(ee=e.R8I),B===e.SHORT&&(ee=e.R16I),B===e.INT&&(ee=e.R32I)),y===e.RG&&(B===e.FLOAT&&(ee=e.RG32F),B===e.HALF_FLOAT&&(ee=e.RG16F),B===e.UNSIGNED_BYTE&&(ee=e.RG8),B===e.UNSIGNED_SHORT&&_e&&(ee=_e.RG16_EXT),B===e.SHORT&&_e&&(ee=_e.RG16_SNORM_EXT)),y===e.RG_INTEGER&&(B===e.UNSIGNED_BYTE&&(ee=e.RG8UI),B===e.UNSIGNED_SHORT&&(ee=e.RG16UI),B===e.UNSIGNED_INT&&(ee=e.RG32UI),B===e.BYTE&&(ee=e.RG8I),B===e.SHORT&&(ee=e.RG16I),B===e.INT&&(ee=e.RG32I)),y===e.RGB_INTEGER&&(B===e.UNSIGNED_BYTE&&(ee=e.RGB8UI),B===e.UNSIGNED_SHORT&&(ee=e.RGB16UI),B===e.UNSIGNED_INT&&(ee=e.RGB32UI),B===e.BYTE&&(ee=e.RGB8I),B===e.SHORT&&(ee=e.RGB16I),B===e.INT&&(ee=e.RGB32I)),y===e.RGBA_INTEGER&&(B===e.UNSIGNED_BYTE&&(ee=e.RGBA8UI),B===e.UNSIGNED_SHORT&&(ee=e.RGBA16UI),B===e.UNSIGNED_INT&&(ee=e.RGBA32UI),B===e.BYTE&&(ee=e.RGBA8I),B===e.SHORT&&(ee=e.RGBA16I),B===e.INT&&(ee=e.RGBA32I)),y===e.RGB&&(B===e.UNSIGNED_SHORT&&_e&&(ee=_e.RGB16_EXT),B===e.SHORT&&_e&&(ee=_e.RGB16_SNORM_EXT),B===e.UNSIGNED_INT_5_9_9_9_REV&&(ee=e.RGB9_E5),B===e.UNSIGNED_INT_10F_11F_11F_REV&&(ee=e.R11F_G11F_B10F)),y===e.RGBA){const Z=fe?ou:et.getTransfer(se);B===e.FLOAT&&(ee=e.RGBA32F),B===e.HALF_FLOAT&&(ee=e.RGBA16F),B===e.UNSIGNED_BYTE&&(ee=Z===ft?e.SRGB8_ALPHA8:e.RGBA8),B===e.UNSIGNED_SHORT&&_e&&(ee=_e.RGBA16_EXT),B===e.SHORT&&_e&&(ee=_e.RGBA16_SNORM_EXT),B===e.UNSIGNED_SHORT_4_4_4_4&&(ee=e.RGBA4),B===e.UNSIGNED_SHORT_5_5_5_1&&(ee=e.RGB5_A1)}return(ee===e.R16F||ee===e.R32F||ee===e.RG16F||ee===e.RG32F||ee===e.RGBA16F||ee===e.RGBA32F)&&t.get("EXT_color_buffer_float"),ee}function T(C,y){let B;return C?y===null||y===Si||y===no?B=e.DEPTH24_STENCIL8:y===di?B=e.DEPTH32F_STENCIL8:y===to&&(B=e.DEPTH24_STENCIL8,Ve("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===Si||y===no?B=e.DEPTH_COMPONENT24:y===di?B=e.DEPTH_COMPONENT32F:y===to&&(B=e.DEPTH_COMPONENT16),B}function b(C,y){return d(C)===!0||C.isFramebufferTexture&&C.minFilter!==jt&&C.minFilter!==en?Math.log2(Math.max(y.width,y.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?y.mipmaps.length:1}function w(C){const y=C.target;y.removeEventListener("dispose",w),x(y),y.isVideoTexture&&f.delete(y),y.isHTMLTexture&&h.delete(y)}function S(C){const y=C.target;y.removeEventListener("dispose",S),R(y)}function x(C){const y=i.get(C);if(y.__webglInit===void 0)return;const B=C.source,X=p.get(B);if(X){const se=X[y.__cacheKey];se.usedTimes--,se.usedTimes===0&&P(C),Object.keys(X).length===0&&p.delete(B)}i.remove(C)}function P(C){const y=i.get(C);e.deleteTexture(y.__webglTexture);const B=C.source,X=p.get(B);delete X[y.__cacheKey],a.memory.textures--}function R(C){const y=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(y.__webglFramebuffer[X]))for(let se=0;se<y.__webglFramebuffer[X].length;se++)e.deleteFramebuffer(y.__webglFramebuffer[X][se]);else e.deleteFramebuffer(y.__webglFramebuffer[X]);y.__webglDepthbuffer&&e.deleteRenderbuffer(y.__webglDepthbuffer[X])}else{if(Array.isArray(y.__webglFramebuffer))for(let X=0;X<y.__webglFramebuffer.length;X++)e.deleteFramebuffer(y.__webglFramebuffer[X]);else e.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&e.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&e.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let X=0;X<y.__webglColorRenderbuffer.length;X++)y.__webglColorRenderbuffer[X]&&e.deleteRenderbuffer(y.__webglColorRenderbuffer[X]);y.__webglDepthRenderbuffer&&e.deleteRenderbuffer(y.__webglDepthRenderbuffer)}const B=C.textures;for(let X=0,se=B.length;X<se;X++){const fe=i.get(B[X]);fe.__webglTexture&&(e.deleteTexture(fe.__webglTexture),a.memory.textures--),i.remove(B[X])}i.remove(C)}let N=0;function U(){N=0}function k(){return N}function L(C){N=C}function z(){const C=N;return C>=r.maxTextures&&Ve("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+r.maxTextures),N+=1,C}function H(C){const y=[];return y.push(C.wrapS),y.push(C.wrapT),y.push(C.wrapR||0),y.push(C.magFilter),y.push(C.minFilter),y.push(C.anisotropy),y.push(C.internalFormat),y.push(C.format),y.push(C.type),y.push(C.generateMipmaps),y.push(C.premultiplyAlpha),y.push(C.flipY),y.push(C.unpackAlignment),y.push(C.colorSpace),y.join()}function D(C,y){const B=i.get(C);if(C.isVideoTexture&&le(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&B.__version!==C.version){const X=C.image;if(X===null)Ve("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)Ve("WebGLRenderer: Texture marked for update but image is incomplete");else{Pe(B,C,y);return}}else C.isExternalTexture&&(B.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,B.__webglTexture,e.TEXTURE0+y)}function j(C,y){const B=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&B.__version!==C.version){Pe(B,C,y);return}else C.isExternalTexture&&(B.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D_ARRAY,B.__webglTexture,e.TEXTURE0+y)}function J(C,y){const B=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&B.__version!==C.version){Pe(B,C,y);return}n.bindTexture(e.TEXTURE_3D,B.__webglTexture,e.TEXTURE0+y)}function ae(C,y){const B=i.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&B.__version!==C.version){ze(B,C,y);return}n.bindTexture(e.TEXTURE_CUBE_MAP,B.__webglTexture,e.TEXTURE0+y)}const de={[Qf]:e.REPEAT,[Ni]:e.CLAMP_TO_EDGE,[Jf]:e.MIRRORED_REPEAT},Ne={[jt]:e.NEAREST,[P2]:e.NEAREST_MIPMAP_NEAREST,[Uo]:e.NEAREST_MIPMAP_LINEAR,[en]:e.LINEAR,[dc]:e.LINEAR_MIPMAP_NEAREST,[zr]:e.LINEAR_MIPMAP_LINEAR},Be={[L2]:e.NEVER,[k2]:e.ALWAYS,[D2]:e.LESS,[qh]:e.LEQUAL,[U2]:e.EQUAL,[Kh]:e.GEQUAL,[F2]:e.GREATER,[O2]:e.NOTEQUAL};function De(C,y){if(y.type===di&&t.has("OES_texture_float_linear")===!1&&(y.magFilter===en||y.magFilter===dc||y.magFilter===Uo||y.magFilter===zr||y.minFilter===en||y.minFilter===dc||y.minFilter===Uo||y.minFilter===zr)&&Ve("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(C,e.TEXTURE_WRAP_S,de[y.wrapS]),e.texParameteri(C,e.TEXTURE_WRAP_T,de[y.wrapT]),(C===e.TEXTURE_3D||C===e.TEXTURE_2D_ARRAY)&&e.texParameteri(C,e.TEXTURE_WRAP_R,de[y.wrapR]),e.texParameteri(C,e.TEXTURE_MAG_FILTER,Ne[y.magFilter]),e.texParameteri(C,e.TEXTURE_MIN_FILTER,Ne[y.minFilter]),y.compareFunction&&(e.texParameteri(C,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(C,e.TEXTURE_COMPARE_FUNC,Be[y.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===jt||y.minFilter!==Uo&&y.minFilter!==zr||y.type===di&&t.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||i.get(y).__currentAnisotropy){const B=t.get("EXT_texture_filter_anisotropic");e.texParameterf(C,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,r.getMaxAnisotropy())),i.get(y).__currentAnisotropy=y.anisotropy}}}function Q(C,y){let B=!1;C.__webglInit===void 0&&(C.__webglInit=!0,y.addEventListener("dispose",w));const X=y.source;let se=p.get(X);se===void 0&&(se={},p.set(X,se));const fe=H(y);if(fe!==C.__cacheKey){se[fe]===void 0&&(se[fe]={texture:e.createTexture(),usedTimes:0},a.memory.textures++,B=!0),se[fe].usedTimes++;const _e=se[C.__cacheKey];_e!==void 0&&(se[C.__cacheKey].usedTimes--,_e.usedTimes===0&&P(y)),C.__cacheKey=fe,C.__webglTexture=se[fe].texture}return B}function ge(C,y,B){return Math.floor(Math.floor(C/B)/y)}function he(C,y,B,X){const fe=C.updateRanges;if(fe.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,y.width,y.height,B,X,y.data);else{fe.sort((Ee,ie)=>Ee.start-ie.start);let _e=0;for(let Ee=1;Ee<fe.length;Ee++){const ie=fe[_e],te=fe[Ee],ce=ie.start+ie.count,Ie=ge(te.start,y.width,4),$e=ge(ie.start,y.width,4);te.start<=ce+1&&Ie===$e&&ge(te.start+te.count-1,y.width,4)===Ie?ie.count=Math.max(ie.count,te.start+te.count-ie.start):(++_e,fe[_e]=te)}fe.length=_e+1;const ee=n.getParameter(e.UNPACK_ROW_LENGTH),Z=n.getParameter(e.UNPACK_SKIP_PIXELS),Me=n.getParameter(e.UNPACK_SKIP_ROWS);n.pixelStorei(e.UNPACK_ROW_LENGTH,y.width);for(let Ee=0,ie=fe.length;Ee<ie;Ee++){const te=fe[Ee],ce=Math.floor(te.start/4),Ie=Math.ceil(te.count/4),$e=ce%y.width,O=Math.floor(ce/y.width),Se=Ie,ne=1;n.pixelStorei(e.UNPACK_SKIP_PIXELS,$e),n.pixelStorei(e.UNPACK_SKIP_ROWS,O),n.texSubImage2D(e.TEXTURE_2D,0,$e,O,Se,ne,B,X,y.data)}C.clearUpdateRanges(),n.pixelStorei(e.UNPACK_ROW_LENGTH,ee),n.pixelStorei(e.UNPACK_SKIP_PIXELS,Z),n.pixelStorei(e.UNPACK_SKIP_ROWS,Me)}}function Pe(C,y,B){let X=e.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(X=e.TEXTURE_2D_ARRAY),y.isData3DTexture&&(X=e.TEXTURE_3D);const se=Q(C,y),fe=y.source;n.bindTexture(X,C.__webglTexture,e.TEXTURE0+B);const _e=i.get(fe);if(fe.version!==_e.__version||se===!0){if(n.activeTexture(e.TEXTURE0+B),(typeof ImageBitmap<"u"&&y.image instanceof ImageBitmap)===!1){const ne=et.getPrimaries(et.workingColorSpace),xe=y.colorSpace===sr?null:et.getPrimaries(y.colorSpace),ye=y.colorSpace===sr||ne===xe?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,y.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,ye)}n.pixelStorei(e.UNPACK_ALIGNMENT,y.unpackAlignment);let Z=g(y.image,!1,r.maxTextureSize);Z=K(y,Z);const Me=s.convert(y.format,y.colorSpace),Ee=s.convert(y.type);let ie=E(y.internalFormat,Me,Ee,y.normalized,y.colorSpace,y.isVideoTexture);De(X,y);let te;const ce=y.mipmaps,Ie=y.isVideoTexture!==!0,$e=_e.__version===void 0||se===!0,O=fe.dataReady,Se=b(y,Z);if(y.isDepthTexture)ie=T(y.format===Gr,y.type),$e&&(Ie?n.texStorage2D(e.TEXTURE_2D,1,ie,Z.width,Z.height):n.texImage2D(e.TEXTURE_2D,0,ie,Z.width,Z.height,0,Me,Ee,null));else if(y.isDataTexture)if(ce.length>0){Ie&&$e&&n.texStorage2D(e.TEXTURE_2D,Se,ie,ce[0].width,ce[0].height);for(let ne=0,xe=ce.length;ne<xe;ne++)te=ce[ne],Ie?O&&n.texSubImage2D(e.TEXTURE_2D,ne,0,0,te.width,te.height,Me,Ee,te.data):n.texImage2D(e.TEXTURE_2D,ne,ie,te.width,te.height,0,Me,Ee,te.data);y.generateMipmaps=!1}else Ie?($e&&n.texStorage2D(e.TEXTURE_2D,Se,ie,Z.width,Z.height),O&&he(y,Z,Me,Ee)):n.texImage2D(e.TEXTURE_2D,0,ie,Z.width,Z.height,0,Me,Ee,Z.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){Ie&&$e&&n.texStorage3D(e.TEXTURE_2D_ARRAY,Se,ie,ce[0].width,ce[0].height,Z.depth);for(let ne=0,xe=ce.length;ne<xe;ne++)if(te=ce[ne],y.format!==Zn)if(Me!==null)if(Ie){if(O)if(y.layerUpdates.size>0){const ye=bm(te.width,te.height,y.format,y.type);for(const ue of y.layerUpdates){const Ue=te.data.subarray(ue*ye/te.data.BYTES_PER_ELEMENT,(ue+1)*ye/te.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,ne,0,0,ue,te.width,te.height,1,Me,Ue)}y.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,ne,0,0,0,te.width,te.height,Z.depth,Me,te.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,ne,ie,te.width,te.height,Z.depth,0,te.data,0,0);else Ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ie?O&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,ne,0,0,0,te.width,te.height,Z.depth,Me,Ee,te.data):n.texImage3D(e.TEXTURE_2D_ARRAY,ne,ie,te.width,te.height,Z.depth,0,Me,Ee,te.data)}else{Ie&&$e&&n.texStorage2D(e.TEXTURE_2D,Se,ie,ce[0].width,ce[0].height);for(let ne=0,xe=ce.length;ne<xe;ne++)te=ce[ne],y.format!==Zn?Me!==null?Ie?O&&n.compressedTexSubImage2D(e.TEXTURE_2D,ne,0,0,te.width,te.height,Me,te.data):n.compressedTexImage2D(e.TEXTURE_2D,ne,ie,te.width,te.height,0,te.data):Ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ie?O&&n.texSubImage2D(e.TEXTURE_2D,ne,0,0,te.width,te.height,Me,Ee,te.data):n.texImage2D(e.TEXTURE_2D,ne,ie,te.width,te.height,0,Me,Ee,te.data)}else if(y.isDataArrayTexture)if(Ie){if($e&&n.texStorage3D(e.TEXTURE_2D_ARRAY,Se,ie,Z.width,Z.height,Z.depth),O)if(y.layerUpdates.size>0){const ne=bm(Z.width,Z.height,y.format,y.type);for(const xe of y.layerUpdates){const ye=Z.data.subarray(xe*ne/Z.data.BYTES_PER_ELEMENT,(xe+1)*ne/Z.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,xe,Z.width,Z.height,1,Me,Ee,ye)}y.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,Z.width,Z.height,Z.depth,Me,Ee,Z.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,ie,Z.width,Z.height,Z.depth,0,Me,Ee,Z.data);else if(y.isData3DTexture)Ie?($e&&n.texStorage3D(e.TEXTURE_3D,Se,ie,Z.width,Z.height,Z.depth),O&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,Z.width,Z.height,Z.depth,Me,Ee,Z.data)):n.texImage3D(e.TEXTURE_3D,0,ie,Z.width,Z.height,Z.depth,0,Me,Ee,Z.data);else if(y.isFramebufferTexture){if($e)if(Ie)n.texStorage2D(e.TEXTURE_2D,Se,ie,Z.width,Z.height);else{let ne=Z.width,xe=Z.height;for(let ye=0;ye<Se;ye++)n.texImage2D(e.TEXTURE_2D,ye,ie,ne,xe,0,Me,Ee,null),ne>>=1,xe>>=1}}else if(y.isHTMLTexture){if("texElementImage2D"in e){const ne=e.canvas;if(ne.hasAttribute("layoutsubtree")||ne.setAttribute("layoutsubtree","true"),Z.parentNode!==ne){ne.appendChild(Z),h.add(y),ne.onpaint=je=>{const Pt=je.changedElements;for(const ht of h)Pt.includes(ht.image)&&(ht.needsUpdate=!0)},ne.requestPaint();return}const xe=0,ye=e.RGBA,ue=e.RGBA,Ue=e.UNSIGNED_BYTE;e.texElementImage2D(e.TEXTURE_2D,xe,ye,ue,Ue,Z),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE)}}else if(ce.length>0){if(Ie&&$e){const ne=pe(ce[0]);n.texStorage2D(e.TEXTURE_2D,Se,ie,ne.width,ne.height)}for(let ne=0,xe=ce.length;ne<xe;ne++)te=ce[ne],Ie?O&&n.texSubImage2D(e.TEXTURE_2D,ne,0,0,Me,Ee,te):n.texImage2D(e.TEXTURE_2D,ne,ie,Me,Ee,te);y.generateMipmaps=!1}else if(Ie){if($e){const ne=pe(Z);n.texStorage2D(e.TEXTURE_2D,Se,ie,ne.width,ne.height)}O&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,Me,Ee,Z)}else n.texImage2D(e.TEXTURE_2D,0,ie,Me,Ee,Z);d(y)&&v(X),_e.__version=fe.version,y.onUpdate&&y.onUpdate(y)}C.__version=y.version}function ze(C,y,B){if(y.image.length!==6)return;const X=Q(C,y),se=y.source;n.bindTexture(e.TEXTURE_CUBE_MAP,C.__webglTexture,e.TEXTURE0+B);const fe=i.get(se);if(se.version!==fe.__version||X===!0){n.activeTexture(e.TEXTURE0+B);const _e=et.getPrimaries(et.workingColorSpace),ee=y.colorSpace===sr?null:et.getPrimaries(y.colorSpace),Z=y.colorSpace===sr||_e===ee?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,y.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),n.pixelStorei(e.UNPACK_ALIGNMENT,y.unpackAlignment),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,Z);const Me=y.isCompressedTexture||y.image[0].isCompressedTexture,Ee=y.image[0]&&y.image[0].isDataTexture,ie=[];for(let ue=0;ue<6;ue++)!Me&&!Ee?ie[ue]=g(y.image[ue],!0,r.maxCubemapSize):ie[ue]=Ee?y.image[ue].image:y.image[ue],ie[ue]=K(y,ie[ue]);const te=ie[0],ce=s.convert(y.format,y.colorSpace),Ie=s.convert(y.type),$e=E(y.internalFormat,ce,Ie,y.normalized,y.colorSpace),O=y.isVideoTexture!==!0,Se=fe.__version===void 0||X===!0,ne=se.dataReady;let xe=b(y,te);De(e.TEXTURE_CUBE_MAP,y);let ye;if(Me){O&&Se&&n.texStorage2D(e.TEXTURE_CUBE_MAP,xe,$e,te.width,te.height);for(let ue=0;ue<6;ue++){ye=ie[ue].mipmaps;for(let Ue=0;Ue<ye.length;Ue++){const je=ye[Ue];y.format!==Zn?ce!==null?O?ne&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ue,Ue,0,0,je.width,je.height,ce,je.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ue,Ue,$e,je.width,je.height,0,je.data):Ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):O?ne&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ue,Ue,0,0,je.width,je.height,ce,Ie,je.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ue,Ue,$e,je.width,je.height,0,ce,Ie,je.data)}}}else{if(ye=y.mipmaps,O&&Se){ye.length>0&&xe++;const ue=pe(ie[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,xe,$e,ue.width,ue.height)}for(let ue=0;ue<6;ue++)if(Ee){O?ne&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,0,0,ie[ue].width,ie[ue].height,ce,Ie,ie[ue].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,$e,ie[ue].width,ie[ue].height,0,ce,Ie,ie[ue].data);for(let Ue=0;Ue<ye.length;Ue++){const Pt=ye[Ue].image[ue].image;O?ne&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ue,Ue+1,0,0,Pt.width,Pt.height,ce,Ie,Pt.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ue,Ue+1,$e,Pt.width,Pt.height,0,ce,Ie,Pt.data)}}else{O?ne&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,0,0,ce,Ie,ie[ue]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,$e,ce,Ie,ie[ue]);for(let Ue=0;Ue<ye.length;Ue++){const je=ye[Ue];O?ne&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ue,Ue+1,0,0,ce,Ie,je.image[ue]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ue,Ue+1,$e,ce,Ie,je.image[ue])}}}d(y)&&v(e.TEXTURE_CUBE_MAP),fe.__version=se.version,y.onUpdate&&y.onUpdate(y)}C.__version=y.version}function Oe(C,y,B,X,se,fe){const _e=s.convert(B.format,B.colorSpace),ee=s.convert(B.type),Z=E(B.internalFormat,_e,ee,B.normalized,B.colorSpace),Me=i.get(y),Ee=i.get(B);if(Ee.__renderTarget=y,!Me.__hasExternalTextures){const ie=Math.max(1,y.width>>fe),te=Math.max(1,y.height>>fe);se===e.TEXTURE_3D||se===e.TEXTURE_2D_ARRAY?n.texImage3D(se,fe,Z,ie,te,y.depth,0,_e,ee,null):n.texImage2D(se,fe,Z,ie,te,0,_e,ee,null)}n.bindFramebuffer(e.FRAMEBUFFER,C),oe(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,X,se,Ee.__webglTexture,0,re(y)):(se===e.TEXTURE_2D||se>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&se<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,X,se,Ee.__webglTexture,fe),n.bindFramebuffer(e.FRAMEBUFFER,null)}function nt(C,y,B){if(e.bindRenderbuffer(e.RENDERBUFFER,C),y.depthBuffer){const X=y.depthTexture,se=X&&X.isDepthTexture?X.type:null,fe=T(y.stencilBuffer,se),_e=y.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;oe(y)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,re(y),fe,y.width,y.height):B?e.renderbufferStorageMultisample(e.RENDERBUFFER,re(y),fe,y.width,y.height):e.renderbufferStorage(e.RENDERBUFFER,fe,y.width,y.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,_e,e.RENDERBUFFER,C)}else{const X=y.textures;for(let se=0;se<X.length;se++){const fe=X[se],_e=s.convert(fe.format,fe.colorSpace),ee=s.convert(fe.type),Z=E(fe.internalFormat,_e,ee,fe.normalized,fe.colorSpace);oe(y)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,re(y),Z,y.width,y.height):B?e.renderbufferStorageMultisample(e.RENDERBUFFER,re(y),Z,y.width,y.height):e.renderbufferStorage(e.RENDERBUFFER,Z,y.width,y.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function He(C,y,B){const X=y.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(e.FRAMEBUFFER,C),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const se=i.get(y.depthTexture);if(se.__renderTarget=y,(!se.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),X){if(se.__webglInit===void 0&&(se.__webglInit=!0,y.depthTexture.addEventListener("dispose",w)),se.__webglTexture===void 0){se.__webglTexture=e.createTexture(),n.bindTexture(e.TEXTURE_CUBE_MAP,se.__webglTexture),De(e.TEXTURE_CUBE_MAP,y.depthTexture);const Me=s.convert(y.depthTexture.format),Ee=s.convert(y.depthTexture.type);let ie;y.depthTexture.format===Vi?ie=e.DEPTH_COMPONENT24:y.depthTexture.format===Gr&&(ie=e.DEPTH24_STENCIL8);for(let te=0;te<6;te++)e.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,ie,y.width,y.height,0,Me,Ee,null)}}else D(y.depthTexture,0);const fe=se.__webglTexture,_e=re(y),ee=X?e.TEXTURE_CUBE_MAP_POSITIVE_X+B:e.TEXTURE_2D,Z=y.depthTexture.format===Gr?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;if(y.depthTexture.format===Vi)oe(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,Z,ee,fe,0,_e):e.framebufferTexture2D(e.FRAMEBUFFER,Z,ee,fe,0);else if(y.depthTexture.format===Gr)oe(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,Z,ee,fe,0,_e):e.framebufferTexture2D(e.FRAMEBUFFER,Z,ee,fe,0);else throw new Error("Unknown depthTexture format")}function Qe(C){const y=i.get(C),B=C.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==C.depthTexture){const X=C.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),X){const se=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,X.removeEventListener("dispose",se)};X.addEventListener("dispose",se),y.__depthDisposeCallback=se}y.__boundDepthTexture=X}if(C.depthTexture&&!y.__autoAllocateDepthBuffer)if(B)for(let X=0;X<6;X++)He(y.__webglFramebuffer[X],C,X);else{const X=C.texture.mipmaps;X&&X.length>0?He(y.__webglFramebuffer[0],C,0):He(y.__webglFramebuffer,C,0)}else if(B){y.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer[X]),y.__webglDepthbuffer[X]===void 0)y.__webglDepthbuffer[X]=e.createRenderbuffer(),nt(y.__webglDepthbuffer[X],C,!1);else{const se=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,fe=y.__webglDepthbuffer[X];e.bindRenderbuffer(e.RENDERBUFFER,fe),e.framebufferRenderbuffer(e.FRAMEBUFFER,se,e.RENDERBUFFER,fe)}}else{const X=C.texture.mipmaps;if(X&&X.length>0?n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=e.createRenderbuffer(),nt(y.__webglDepthbuffer,C,!1);else{const se=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,fe=y.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,fe),e.framebufferRenderbuffer(e.FRAMEBUFFER,se,e.RENDERBUFFER,fe)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function ut(C,y,B){const X=i.get(C);y!==void 0&&Oe(X.__webglFramebuffer,C,C.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),B!==void 0&&Qe(C)}function ve(C){const y=C.texture,B=i.get(C),X=i.get(y);C.addEventListener("dispose",S);const se=C.textures,fe=C.isWebGLCubeRenderTarget===!0,_e=se.length>1;if(_e||(X.__webglTexture===void 0&&(X.__webglTexture=e.createTexture()),X.__version=y.version,a.memory.textures++),fe){B.__webglFramebuffer=[];for(let ee=0;ee<6;ee++)if(y.mipmaps&&y.mipmaps.length>0){B.__webglFramebuffer[ee]=[];for(let Z=0;Z<y.mipmaps.length;Z++)B.__webglFramebuffer[ee][Z]=e.createFramebuffer()}else B.__webglFramebuffer[ee]=e.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){B.__webglFramebuffer=[];for(let ee=0;ee<y.mipmaps.length;ee++)B.__webglFramebuffer[ee]=e.createFramebuffer()}else B.__webglFramebuffer=e.createFramebuffer();if(_e)for(let ee=0,Z=se.length;ee<Z;ee++){const Me=i.get(se[ee]);Me.__webglTexture===void 0&&(Me.__webglTexture=e.createTexture(),a.memory.textures++)}if(C.samples>0&&oe(C)===!1){B.__webglMultisampledFramebuffer=e.createFramebuffer(),B.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let ee=0;ee<se.length;ee++){const Z=se[ee];B.__webglColorRenderbuffer[ee]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,B.__webglColorRenderbuffer[ee]);const Me=s.convert(Z.format,Z.colorSpace),Ee=s.convert(Z.type),ie=E(Z.internalFormat,Me,Ee,Z.normalized,Z.colorSpace,C.isXRRenderTarget===!0),te=re(C);e.renderbufferStorageMultisample(e.RENDERBUFFER,te,ie,C.width,C.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+ee,e.RENDERBUFFER,B.__webglColorRenderbuffer[ee])}e.bindRenderbuffer(e.RENDERBUFFER,null),C.depthBuffer&&(B.__webglDepthRenderbuffer=e.createRenderbuffer(),nt(B.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(fe){n.bindTexture(e.TEXTURE_CUBE_MAP,X.__webglTexture),De(e.TEXTURE_CUBE_MAP,y);for(let ee=0;ee<6;ee++)if(y.mipmaps&&y.mipmaps.length>0)for(let Z=0;Z<y.mipmaps.length;Z++)Oe(B.__webglFramebuffer[ee][Z],C,y,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Z);else Oe(B.__webglFramebuffer[ee],C,y,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0);d(y)&&v(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(_e){for(let ee=0,Z=se.length;ee<Z;ee++){const Me=se[ee],Ee=i.get(Me);let ie=e.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ie=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(ie,Ee.__webglTexture),De(ie,Me),Oe(B.__webglFramebuffer,C,Me,e.COLOR_ATTACHMENT0+ee,ie,0),d(Me)&&v(ie)}n.unbindTexture()}else{let ee=e.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ee=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(ee,X.__webglTexture),De(ee,y),y.mipmaps&&y.mipmaps.length>0)for(let Z=0;Z<y.mipmaps.length;Z++)Oe(B.__webglFramebuffer[Z],C,y,e.COLOR_ATTACHMENT0,ee,Z);else Oe(B.__webglFramebuffer,C,y,e.COLOR_ATTACHMENT0,ee,0);d(y)&&v(ee),n.unbindTexture()}C.depthBuffer&&Qe(C)}function ot(C){const y=C.textures;for(let B=0,X=y.length;B<X;B++){const se=y[B];if(d(se)){const fe=M(C),_e=i.get(se).__webglTexture;n.bindTexture(fe,_e),v(fe),n.unbindTexture()}}}const Je=[],Ge=[];function F(C){if(C.samples>0){if(oe(C)===!1){const y=C.textures,B=C.width,X=C.height;let se=e.COLOR_BUFFER_BIT;const fe=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,_e=i.get(C),ee=y.length>1;if(ee)for(let Me=0;Me<y.length;Me++)n.bindFramebuffer(e.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+Me,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,_e.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+Me,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,_e.__webglMultisampledFramebuffer);const Z=C.texture.mipmaps;Z&&Z.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,_e.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,_e.__webglFramebuffer);for(let Me=0;Me<y.length;Me++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(se|=e.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(se|=e.STENCIL_BUFFER_BIT)),ee){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,_e.__webglColorRenderbuffer[Me]);const Ee=i.get(y[Me]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,Ee,0)}e.blitFramebuffer(0,0,B,X,0,0,B,X,se,e.NEAREST),l===!0&&(Je.length=0,Ge.length=0,Je.push(e.COLOR_ATTACHMENT0+Me),C.depthBuffer&&C.resolveDepthBuffer===!1&&(Je.push(fe),Ge.push(fe),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,Ge)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,Je))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),ee)for(let Me=0;Me<y.length;Me++){n.bindFramebuffer(e.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+Me,e.RENDERBUFFER,_e.__webglColorRenderbuffer[Me]);const Ee=i.get(y[Me]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,_e.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+Me,e.TEXTURE_2D,Ee,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,_e.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const y=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[y])}}}function re(C){return Math.min(r.maxSamples,C.samples)}function oe(C){const y=i.get(C);return C.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function le(C){const y=a.render.frame;f.get(C)!==y&&(f.set(C,y),C.update())}function K(C,y){const B=C.colorSpace,X=C.format,se=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||B!==au&&B!==sr&&(et.getTransfer(B)===ft?(X!==Zn||se!==bn)&&Ve("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):st("WebGLTextures: Unsupported texture color space:",B)),y}function pe(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(u.width=C.naturalWidth||C.width,u.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(u.width=C.displayWidth,u.height=C.displayHeight):(u.width=C.width,u.height=C.height),u}this.allocateTextureUnit=z,this.resetTextureUnits=U,this.getTextureUnits=k,this.setTextureUnits=L,this.setTexture2D=D,this.setTexture2DArray=j,this.setTexture3D=J,this.setTextureCube=ae,this.rebindTextures=ut,this.setupRenderTarget=ve,this.updateRenderTargetMipmap=ot,this.updateMultisampleRenderTarget=F,this.setupDepthRenderbuffer=Qe,this.setupFrameBufferTexture=Oe,this.useMultisampledRTT=oe,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function pA(e,t){function n(i,r=sr){let s;const a=et.getTransfer(r);if(i===bn)return e.UNSIGNED_BYTE;if(i===Wh)return e.UNSIGNED_SHORT_4_4_4_4;if(i===jh)return e.UNSIGNED_SHORT_5_5_5_1;if(i===x_)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===A_)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===b_)return e.BYTE;if(i===w_)return e.SHORT;if(i===to)return e.UNSIGNED_SHORT;if(i===Hh)return e.INT;if(i===Si)return e.UNSIGNED_INT;if(i===di)return e.FLOAT;if(i===Gi)return e.HALF_FLOAT;if(i===C_)return e.ALPHA;if(i===R_)return e.RGB;if(i===Zn)return e.RGBA;if(i===Vi)return e.DEPTH_COMPONENT;if(i===Gr)return e.DEPTH_STENCIL;if(i===P_)return e.RED;if(i===Xh)return e.RED_INTEGER;if(i===Zr)return e.RG;if(i===$h)return e.RG_INTEGER;if(i===Yh)return e.RGBA_INTEGER;if(i===xl||i===Al||i===Cl||i===Rl)if(a===ft)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===xl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Al)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Cl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Rl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===xl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Al)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Cl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Rl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===ed||i===td||i===nd||i===id)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===ed)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===td)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===nd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===id)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===rd||i===sd||i===ad||i===od||i===ld||i===ru||i===ud)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(i===rd||i===sd)return a===ft?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===ad)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===od)return s.COMPRESSED_R11_EAC;if(i===ld)return s.COMPRESSED_SIGNED_R11_EAC;if(i===ru)return s.COMPRESSED_RG11_EAC;if(i===ud)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===cd||i===fd||i===dd||i===hd||i===pd||i===md||i===gd||i===vd||i===_d||i===Sd||i===yd||i===Md||i===Ed||i===Td)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(i===cd)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===fd)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===dd)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===hd)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===pd)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===md)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===gd)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===vd)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===_d)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Sd)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===yd)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Md)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Ed)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Td)return a===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===bd||i===wd||i===xd)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(i===bd)return a===ft?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===wd)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===xd)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Ad||i===Cd||i===su||i===Rd)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(i===Ad)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Cd)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===su)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Rd)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===no?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}const mA=`
void main() {
...
}`;class vA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,n){if(this.texture===null){const i=new z_(t.texture);(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){const n=t.cameras[0].viewport,i=new Gn({vertexShader:mA,fragmentShader:gA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new ct(new Iu(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class _A extends es{constructor(t,n){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,u=null,f=null,h=null,c=null,p=null,m=null;const _=typeof XRWebGLBinding<"u",g=new vA,d={},v=n.getContextAttributes();let M=null,E=null;const T=[],b=[],w=new lt;let S=null;const x=new Tn;x.viewport=new Rt;const P=new Tn;P.viewport=new Rt;const R=[x,P],N=new CE;let U=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Q){let ge=T[Q];return ge===void 0&&(ge=new yc,T[Q]=ge),ge.getTargetRaySpace()},this.getControllerGrip=function(Q){let ge=T[Q];return ge===void 0&&(ge=new yc,T[Q]=ge),ge.getGripSpace()},this.getHand=function(Q){let ge=T[Q];return ge===void 0&&(ge=new yc,T[Q]=ge),ge.getHandSpace()};function L(Q){const ge=b.indexOf(Q.inputSource);if(ge===-1)return;const he=T[ge];he!==void 0&&(he.update(Q.inputSource,Q.frame,u||a),he.dispatchEvent({type:Q.type,data:Q.inputSource}))}function z(){r.removeEventListener("select",L),r.removeEventListener("selectstart",L),r.removeEventListener("selectend",L),r.removeEventListener("squeeze",L),r.removeEventListener("squeezestart",L),r.removeEventListener("squeezeend",L),r.removeEventListener("end",z),r.removeEventListener("inputsourceschange",H);for(let Q=0;Q<T.length;Q++){const ge=b[Q];ge!==null&&(b[Q]=null,T[Q].disconnect(ge))}U=null,k=null,g.reset();for(const Q in d)delete d[Q];t.setRenderTarget(M),p=null,c=null,h=null,r=null,E=null,De.stop(),i.isPresenting=!1,t.setPixelRatio(S),t.setSize(w.width,w.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Q){s=Q,i.isPresenting===!0&&Ve("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Q){o=Q,i.isPresenting===!0&&Ve("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||a},this.setReferenceSpace=function(Q){u=Q},this.getBaseLayer=function(){return c!==null?c:p},this.getBinding=function(){return h===null&&_&&(h=new XRWebGLBinding(r,n)),h},this.getFrame=function(){return m},this.getSession=function(){return r},this.setSession=async function(Q){if(r=Q,r!==null){if(M=t.getRenderTarget(),r.addEventListener("select",L),r.addEventListener("selectstart",L),r.addEventListener("selectend",L),r.addEventListener("squeeze",L),r.addEventListener("squeezestart",L),r.addEventListener("squeezeend",L),r.addEventListener("end",z),r.addEventListener("inputsourceschange",H),v.xrCompatible!==!0&&await n.makeXRCompatible(),S=t.getPixelRatio(),t.getSize(w),_&&"createProjectionLayer"in XRWebGLBinding.prototype){let he=null,Pe=null,ze=null;v.depth&&(ze=v.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,he=v.stencil?Gr:Vi,Pe=v.stencil?no:Si);const Oe={colorFormat:n.RGBA8,depthFormat:ze,scaleFactor:s};h=this.getBinding(),c=h.createProjectionLayer(Oe),r.updateRenderState({layers:[c]}),t.setPixelRatio(1),t.setSize(c.textureWidth,c.textureHeight,!1),E=new vi(c.textureWidth,c.textureHeight,{format:Zn,type:bn,depthTexture:new Ys(c.textureWidth,c.textureHeight,Pe,void 0,void 0,void 0,void 0,void 0,void 0,he),stencilBuffer:v.stencil,colorSpace:t.outputColorSpace,samples:v.antialias?4:0,resolveDepthBuffer:c.ignoreDepthValues===!1,resolveStencilBuffer:c.ignoreDepthValues===!1})}else{const he={antialias:v.antialias,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,n,he),r.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),E=new vi(p.framebufferWidth,p.framebufferHeight,{format:Zn,type:bn,colorSpace:t.outputColorSpace,stencilBuffer:v.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(l),u=null,a=await r.requestReferenceSpace(o),De.setContext(r),De.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function H(Q){for(let ge=0;ge<Q.removed.length;ge++){const he=Q.removed[ge],Pe=b.indexOf(he);Pe>=0&&(b[Pe]=null,T[Pe].disconnect(he))}for(let ge=0;ge<Q.added.length;ge++){const he=Q.added[ge];let Pe=b.indexOf(he);if(Pe===-1){for(let Oe=0;Oe<T.length;Oe++)if(Oe>=b.length){b.push(he),Pe=Oe;break}else if(b[Oe]===null){b[Oe]=he,Pe=Oe;break}if(Pe===-1)break}const ze=T[Pe];ze&&ze.connect(he)}}const D=new V,j=new V;function J(Q,ge,he){D.setFromMatrixPosition(ge.matrixWorld),j.setFromMatrixPosition(he.matrixWorld);const Pe=D.distanceTo(j),ze=ge.projectionMatrix.elements,Oe=he.projectionMatrix.elements,nt=ze[14]/(ze[10]-1),He=ze[14]/(ze[10]+1),Qe=(ze[9]+1)/ze[5],ut=(ze[9]-1)/ze[5],ve=(ze[8]-1)/ze[0],ot=(Oe[8]+1)/Oe[0],Je=nt*ve,Ge=nt*ot,F=Pe/(-ve+ot),re=F*-ve;if(ge.matrixWorld.decompose(Q.position,Q.quaternion,Q.scale),Q.translateX(re),Q.translateZ(F),Q.matrixWorld.compose(Q.position,Q.quaternion,Q.scale),Q.matrixWorldInverse.copy(Q.matrixWorld).invert(),ze[10]===-1)Q.projectionMatrix.copy(ge.projectionMatrix),Q.projectionMatrixInverse.copy(ge.projectionMatrixInverse);else{const oe=nt+F,le=He+F,K=Je-re,pe=Ge+(Pe-re),C=Qe*He/le*oe,y=ut*He/le*oe;Q.projectionMatrix.makePerspective(K,pe,C,y,oe,le),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert()}}function ae(Q,ge){ge===null?Q.matrixWorld.copy(Q.matrix):Q.matrixWorld.multiplyMatrices(ge.matrixWorld,Q.matrix),Q.matrixWorldInverse.copy(Q.matrixWorld).invert()}this.updateCamera=function(Q){if(r===null)return;let ge=Q.near,he=Q.far;g.texture!==null&&(g.depthNear>0&&(ge=g.depthNear),g.depthFar>0&&(he=g.depthFar)),N.near=P.near=x.near=ge,N.far=P.far=x.far=he,(U!==N.near||k!==N.far)&&(r.updateRenderState({depthNear:N.near,depthFar:N.far}),U=N.near,k=N.far),N.layers.mask=Q.layers.mask|6,x.layers.mask=N.layers.mask&-5,P.layers.mask=N.layers.mask&-3;const Pe=Q.parent,ze=N.cameras;ae(N,Pe);for(let Oe=0;Oe<ze.length;Oe++)ae(ze[Oe],Pe);ze.length===2?J(N,x,P):N.projectionMatrix.copy(x.projectionMatrix),de(Q,N,Pe)};function de(Q,ge,he){he===null?Q.matrix.copy(ge.matrixWorld):(Q.matrix.copy(he.matrixWorld),Q.matrix.invert(),Q.matrix.multiply(ge.matrixWorld)),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.updateMatrixWorld(!0),Q.projectionMatrix.copy(ge.projectionMatrix),Q.projectionMatrixInverse.copy(ge.projectionMatrixInverse),Q.isPerspectiveCamera&&(Q.fov=Nd*2*Math.atan(1/Q.projectionMatrix.elements[5]),Q.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(c===null&&p===null))return l},this.setFoveation=function(Q){l=Q,c!==null&&(c.fixedFoveation=Q),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=Q)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(N)},this.getCameraTexture=function(Q){return d[Q]};let Ne=null;function Be(Q,ge){if(f=ge.getViewerPose(u||a),m=ge,f!==null){const he=f.views;p!==null&&(t.setRenderTargetFramebuffer(E,p.framebuffer),t.setRenderTarget(E));let Pe=!1;he.length!==N.cameras.length&&(N.cameras.length=0,Pe=!0);for(let He=0;He<he.length;He++){const Qe=he[He];let ut=null;if(p!==null)ut=p.getViewport(Qe);else{const ot=h.getViewSubImage(c,Qe);ut=ot.viewport,He===0&&(t.setRenderTargetTextures(E,ot.colorTexture,ot.depthStencilTexture),t.setRenderTarget(E))}let ve=R[He];ve===void 0&&(ve=new Tn,ve.layers.enable(He),ve.viewport=new Rt,R[He]=ve),ve.matrix.fromArray(Qe.transform.matrix),ve.matrix.decompose(ve.position,ve.quaternion,ve.scale),ve.projectionMatrix.fromArray(Qe.projectionMatrix),ve.projectionMatrixInverse.copy(ve.projectionMatrix).invert(),ve.viewport.set(ut.x,ut.y,ut.width,ut.height),He===0&&(N.matrix.copy(ve.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),Pe===!0&&N.cameras.push(ve)}const ze=r.enabledFeatures;if(ze&&ze.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&_){h=i.getBinding();const He=h.getDepthInformation(he[0]);He&&He.isValid&&He.texture&&g.init(He,r.renderState)}if(ze&&ze.includes("camera-access")&&_){t.state.unbindTexture(),h=i.getBinding();for(let He=0;He<he.length;He++){const Qe=he[He].camera;if(Qe){let ut=d[Qe];ut||(ut=new z_,d[Qe]=ut);const ve=h.getCameraImage(Qe);ut.sourceTexture=ve}}}}for(let he=0;he<T.length;he++){const Pe=b[he],ze=T[he];Pe!==null&&ze!==void 0&&ze.update(Pe,ge,u||a)}Ne&&Ne(Q,ge),ge.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ge}),m=null}const De=new W_;De.setAnimationLoop(Be),this.setAnimationLoop=function(Q){Ne=Q},this.dispose=function(){}}}const SA=new wt,Z_=new We;Z_.set(-1,0,0,0,1,0,0,0,1);function yA(e,t){function n(g,d){g.matrixAutoUpdate===!0&&g.updateMatrix(),d.value.copy(g.matrix)}function i(g,d){d.color.getRGB(g.fogColor.value,G_(e)),d.isFog?(g.fogNear.value=d.near,g.fogFar.value=d.far):d.isFogExp2&&(g.fogDensity.value=d.density)}function r(g,d,v,M,E){d.isNodeMaterial?d.uniformsNeedUpdate=!1:d.isMeshBasicMaterial?s(g,d):d.isMeshLambertMaterial?(s(g,d),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)):d.isMeshToonMaterial?(s(g,d),h(g,d)):d.isMeshPhongMaterial?(s(g,d),f(g,d),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)):d.isMeshStandardMaterial?(s(g,d),c(g,d),d.isMeshPhysicalMaterial&&p(g,d,E)):d.isMeshMatcapMaterial?(s(g,d),m(g,d)):d.isMeshDepthMaterial?s(g,d):d.isMeshDistanceMaterial?(s(g,d),_(g,d)):d.isMeshNormalMaterial?s(g,d):d.isLineBasicMaterial?(a(g,d),d.isLineDashedMaterial&&o(g,d)):d.isPointsMaterial?l(g,d,v,M):d.isSpriteMaterial?u(g,d):d.isShadowMaterial?(g.color.value.copy(d.color),g.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(g,d){g.opacity.value=d.opacity,d.color&&g.diffuse.value.copy(d.color),d.emissive&&g.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(g.map.value=d.map,n(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,n(d.alphaMap,g.alphaMapTransform)),d.bumpMap&&(g.bumpMap.value=d.bumpMap,n(d.bumpMap,g.bumpMapTransform),g.bumpScale.value=d.bumpScale,d.side===_n&&(g.bumpScale.value*=-1)),d.normalMap&&(g.normalMap.value=d.normalMap,n(d.normalMap,g.normalMapTransform),g.normalScale.value.copy(d.normalScale),d.side===_n&&g.normalScale.value.negate()),d.displacementMap&&(g.displacementMap.value=d.displacementMap,n(d.displacementMap,g.displacementMapTransform),g.displacementScale.value=d.displacementScale,g.displacementBias.value=d.displacementBias),d.emissiveMap&&(g.emissiveMap.value=d.emissiveMap,n(d.emissiveMap,g.emissiveMapTransform)),d.specularMap&&(g.specularMap.value=d.specularMap,n(d.specularMap,g.specularMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest);const v=t.get(d),M=v.envMap,E=v.envMapRotation;M&&(g.envMap.value=M,g.envMapRotation.value.setFromMatrix4(SA.makeRotationFromEuler(E)).transpose(),M.isCubeTexture&&M.isRenderTargetTexture===!1&&g.envMapRotation.value.premultiply(Z_),g.reflectivity.value=d.reflectivity,g.ior.value=d.ior,g.refractionRatio.value=d.refractionRatio),d.lightMap&&(g.lightMap.value=d.lightMap,g.lightMapIntensity.value=d.lightMapIntensity,n(d.lightMap,g.lightMapTransform)),d.aoMap&&(g.aoMap.value=d.aoMap,g.aoMapIntensity.value=d.aoMapIntensity,n(d.aoMap,g.aoMapTransform))}function a(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,d.map&&(g.map.value=d.map,n(d.map,g.mapTransform))}function o(g,d){g.dashSize.value=d.dashSize,g.totalSize.value=d.dashSize+d.gapSize,g.scale.value=d.scale}function l(g,d,v,M){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.size.value=d.size*v,g.scale.value=M*.5,d.map&&(g.map.value=d.map,n(d.map,g.uvTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,n(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function u(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.rotation.value=d.rotation,d.map&&(g.map.value=d.map,n(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,n(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function f(g,d){g.specular.value.copy(d.specular),g.shininess.value=Math.max(d.shininess,1e-4)}function h(g,d){d.gradientMap&&(g.gradientMap.value=d.gradientMap)}function c(g,d){g.metalness.value=d.metalness,d.metalnessMap&&(g.metalnessMap.value=d.metalnessMap,n(d.metalnessMap,g.metalnessMapTransform)),g.roughness.value=d.roughness,d.roughnessMap&&(g.roughnessMap.value=d.roughnessMap,n(d.roughnessMap,g.roughnessMapTransform)),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)}function p(g,d,v){g.ior.value=d.ior,d.sheen>0&&(g.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),g.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(g.sheenColorMap.value=d.sheenColorMap,n(d.sheenColorMap,g.sheenColorMapTransform)),d.sheenRoughnessMap&&(g.sheenRoughnessMap.value=d.sheenRoughnessMap,n(d.sheenRoughnessMap,g.sheenRoughnessMapTransform))),d.clearcoat>0&&(g.clearcoat.value=d.clearcoat,g.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(g.clearcoatMap.value=d.clearcoatMap,n(d.clearcoatMap,g.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,n(d.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(g.clearcoatNormalMap.value=d.clearcoatNormalMap,n(d.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===_n&&g.clearcoatNormalScale.value.negate())),d.dispersion>0&&(g.dispersion.value=d.dispersion),d.iridescence>0&&(g.iridescence.value=d.iridescence,g.iridescenceIOR.value=d.iridescenceIOR,g.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(g.iridescenceMap.value=d.iridescenceMap,n(d.iridescenceMap,g.iridescenceMapTransform)),d.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=d.iridescenceThicknessMap,n(d.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),d.transmission>0&&(g.transmission.value=d.transmission,g.transmissionSamplerMap.value=v.texture,g.transmissionSamplerSize.value.set(v.width,v.height),d.transmissionMap&&(g.transmissionMap.value=d.transmissionMap,n(d.transmissionMap,g.transmissionMapTransform)),g.thickness.value=d.thickness,d.thicknessMap&&(g.thicknessMap.value=d.thicknessMap,n(d.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=d.attenuationDistance,g.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(g.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(g.anisotropyMap.value=d.anisotropyMap,n(d.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=d.specularIntensity,g.specularColor.value.copy(d.specularColor),d.specularColorMap&&(g.specularColorMap.value=d.specularColorMap,n(d.specularColorMap,g.specularColorMapTransform)),d.specularIntensityMap&&(g.specularIntensityMap.value=d.specularIntensityMap,n(d.specularIntensityMap,g.specularIntensityMapTransform))}function m(g,d){d.matcap&&(g.matcap.value=d.matcap)}function _(g,d){const v=t.get(d).light;g.referencePosition.value.setFromMatrixPosition(v.matrixWorld),g.nearDistance.value=v.shadow.camera.near,g.farDistance.value=v.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function MA(e,t,n,i){let r={},s={},a=[];const o=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function l(v,M){const E=M.program;i.uniformBlockBinding(v,E)}function u(v,M){let E=r[v.id];E===void 0&&(m(v),E=f(v),r[v.id]=E,v.addEventListener("dispose",g));const T=M.program;i.updateUBOMapping(v,T);const b=t.render.frame;s[v.id]!==b&&(c(v),s[v.id]=b)}function f(v){const M=h();v.__bindingPointIndex=M;const E=e.createBuffer(),T=v.__size,b=v.usage;return e.bindBuffer(e.UNIFORM_BUFFER,E),e.bufferData(e.UNIFORM_BUFFER,T,b),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,M,E),E}function h(){for(let v=0;v<o;v++)if(a.indexOf(v)===-1)return a.push(v),v;return st("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function c(v){const M=r[v.id],E=v.uniforms,T=v.__cache;e.bindBuffer(e.UNIFORM_BUFFER,M);for(let b=0,w=E.length;b<w;b++){const S=Array.isArray(E[b])?E[b]:[E[b]];for(let x=0,P=S.length;x<P;x++){const R=S[x];if(p(R,b,x,T)===!0){const N=R.__offset,U=Array.isArray(R.value)?R.value:[R.value];let k=0;for(let L=0;L<U.length;L++){const z=U[L],H=_(z);typeof z=="number"||typeof z=="boolean"?(R.__data[0]=z,e.bufferSubData(e.UNIFORM_BUFFER,N+k,R.__data)):z.isMatrix3?(R.__data[0]=z.elements[0],R.__data[1]=z.elements[1],R.__data[2]=z.elements[2],R.__data[3]=0,R.__data[4]=z.elements[3],R.__data[5]=z.elements[4],R.__data[6]=z.elements[5],R.__data[7]=0,R.__data[8]=z.elements[6],R.__data[9]=z.elements[7],R.__data[10]=z.elements[8],R.__data[11]=0):ArrayBuffer.isView(z)?R.__data.set(new z.constructor(z.buffer,z.byteOffset,R.__data.length)):(z.toArray(R.__data,k),k+=H.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,N,R.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(v,M,E,T){const b=v.value,w=M+"_"+E;if(T[w]===void 0)return typeof b=="number"||typeof b=="boolean"?T[w]=b:ArrayBuffer.isView(b)?T[w]=b.slice():T[w]=b.clone(),!0;{const S=T[w];if(typeof b=="number"||typeof b=="boolean"){if(S!==b)return T[w]=b,!0}else{if(ArrayBuffer.isView(b))return!0;if(S.equals(b)===!1)return S.copy(b),!0}}return!1}function m(v){const M=v.uniforms;let E=0;const T=16;for(let w=0,S=M.length;w<S;w++){const x=Array.isArray(M[w])?M[w]:[M[w]];for(let P=0,R=x.length;P<R;P++){const N=x[P],U=Array.isArray(N.value)?N.value:[N.value];for(let k=0,L=U.length;k<L;k++){const z=U[k],H=_(z),D=E%T,j=D%H.boundary,J=D+j;E+=j,J!==0&&T-J<H.storage&&(E+=T-J),N.__data=new Float32Array(H.storage/Float32Array.BYTES_PER_ELEMENT),N.__offset=E,E+=H.storage}}}const b=E%T;return b>0&&(E+=T-b),v.__size=E,v.__cache={},this}function _(v){const M={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(M.boundary=4,M.storage=4):v.isVector2?(M.boundary=8,M.storage=8):v.isVector3||v.isColor?(M.boundary=16,M.storage=12):v.isVector4?(M.boundary=16,M.storage=16):v.isMatrix3?(M.boundary=48,M.storage=48):v.isMatrix4?(M.boundary=64,M.storage=64):v.isTexture?Ve("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(v)?(M.boundary=16,M.storage=v.byteLength):Ve("WebGLRenderer: Unsupported uniform value type.",v),M}function g(v){const M=v.target;M.removeEventListener("dispose",g);const E=a.indexOf(M.__bindingPointIndex);a.splice(E,1),e.deleteBuffer(r[M.id]),delete r[M.id],delete s[M.id]}function d(){for(const v in r)e.deleteBuffer(r[v]);a=[],r={},s={}}return{bind:l,update:u,dispose:d}}const EA=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let si=null;function TA(){return si===null&&(si=new uE(EA,16,16,Zr,Gi),si.name="DFG_LUT",si.minFilter=en,si.magFilter=en,si.wrapS=Ni,si.wrapT=Ni,si.generateMipmaps=!1,si.needsUpdate=!0),si}class bA{constructor(t={}){const{canvas:n=z2(),context:i=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:c=!1,outputBufferType:p=bn}=t;this.isWebGLRenderer=!0;let m;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=i.getContextAttributes().alpha}else m=a;const _=p,g=new Set([Yh,$h,Xh]),d=new Set([bn,Si,to,no,Wh,jh]),v=new Uint32Array(4),M=new Int32Array(4),E=new V;let T=null,b=null;const w=[],S=[];let x=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=gi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const P=this;let R=!1,N=null;this._outputColorSpace=Ln;let U=0,k=0,L=null,z=-1,H=null;const D=new Rt,j=new Rt;let J=null;const ae=new qe(0);let de=0,Ne=n.width,Be=n.height,De=1,Q=null,ge=null;const he=new Rt(0,0,Ne,Be),Pe=new Rt(0,0,Ne,Be);let ze=!1;const Oe=new ep;let nt=!1,He=!1;const Qe=new wt,ut=new V,ve=new Rt,ot={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Je=!1;function Ge(){return L===null?De:1}let F=i;function re(A,G){return n.getContext(A,G)}try{const A={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:f,failIfMajorPerformanceCaveat:h};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${zh}`),n.addEventListener("webglcontextlost",ue,!1),n.addEventListener("webglcontextrestored",Ue,!1),n.addEventListener("webglcontextcreationerror",je,!1),F===null){const G="webgl2";if(F=re(G,A),F===null)throw re(G)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw st("WebGLRenderer: "+A.message),A}let oe,le,K,pe,C,y,B,X,se,fe,_e,ee,Z,Me,Ee,ie,te,ce,Ie,$e,O,Se,ne;function xe(){oe=new Tw(F),oe.init(),O=new pA(F,oe),le=new mw(F,oe,t,O),K=new dA(F,oe),le.reversedDepthBuffer&&c&&K.buffers.depth.setReversed(!0),pe=new xw(F),C=new Qx,y=new hA(F,oe,K,C,le,O,pe),B=new Ew(P),X=new PE(F),Se=new hw(F,X),se=new bw(F,X,pe,Se),fe=new Cw(F,se,X,Se,pe),ce=new Aw(F,le,y),Ee=new gw(C),_e=new Zx(P,B,oe,le,Se,Ee),ee=new yA(P,C),Z=new eA,Me=new aA(oe),te=new dw(P,B,K,fe,m,l),ie=new fA(P,fe,le),ne=new MA(F,pe,le,K),Ie=new pw(F,oe,pe),$e=new ww(F,oe,pe),pe.programs=_e.programs,P.capabilities=le,P.extensions=oe,P.properties=C,P.renderLists=Z,P.shadowMap=ie,P.state=K,P.info=pe}xe(),_!==bn&&(x=new Pw(_,n.width,n.height,r,s));const ye=new _A(P,F);this.xr=ye,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){const A=oe.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=oe.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return De},this.setPixelRatio=function(A){A!==void 0&&(De=A,this.setSize(Ne,Be,!1))},this.getSize=function(A){return A.set(Ne,Be)},this.setSize=function(A,G,q=!0){if(ye.isPresenting){Ve("WebGLRenderer: Can't change size while VR device is presenting.");return}Ne=A,Be=G,n.width=Math.floor(A*De),n.height=Math.floor(G*De),q===!0&&(n.style.width=A+"px",n.style.height=G+"px"),x!==null&&x.setSize(n.width,n.height),this.setViewport(0,0,A,G)},this.getDrawingBufferSize=function(A){return A.set(Ne*De,Be*De).floor()},this.setDrawingBufferSize=function(A,G,q){Ne=A,Be=G,De=q,n.width=Math.floor(A*q),n.height=Math.floor(G*q),this.setViewport(0,0,A,G)},this.setEffects=function(A){if(_===bn){st("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(A){for(let G=0;G<A.length;G++)if(A[G].isOutputPass===!0){Ve("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}x.setEffects(A||[])},this.getCurrentViewport=function(A){return A.copy(D)},this.getViewport=function(A){return A.copy(he)},this.setViewport=function(A,G,q,$){A.isVector4?he.set(A.x,A.y,A.z,A.w):he.set(A,G,q,$),K.viewport(D.copy(he).multiplyScalar(De).round())},this.getScissor=function(A){return A.copy(Pe)},this.setScissor=function(A,G,q,$){A.isVector4?Pe.set(A.x,A.y,A.z,A.w):Pe.set(A,G,q,$),K.scissor(j.copy(Pe).multiplyScalar(De).round())},this.getScissorTest=function(){return ze},this.setScissorTest=function(A){K.setScissorTest(ze=A)},this.setOpaqueSort=function(A){Q=A},this.setTransparentSort=function(A){ge=A},this.getClearColor=function(A){return A.copy(te.getClearColor())},this.setClearColor=function(){te.setClearColor(...arguments)},this.getClearAlpha=function(){return te.getClearAlpha()},this.setClearAlpha=function(){te.setClearAlpha(...arguments)},this.clear=function(A=!0,G=!0,q=!0){let $=0;if(A){let Y=!1;if(L!==null){const we=L.texture.format;Y=g.has(we)}if(Y){const we=L.texture.type,Ce=d.has(we),be=te.getClearColor(),Le=te.getClearAlpha(),Fe=be.r,Xe=be.g,Ke=be.b;Ce?(v[0]=Fe,v[1]=Xe,v[2]=Ke,v[3]=Le,F.clearBufferuiv(F.COLOR,0,v)):(M[0]=Fe,M[1]=Xe,M[2]=Ke,M[3]=Le,F.clearBufferiv(F.COLOR,0,M))}else $|=F.COLOR_BUFFER_BIT}G&&($|=F.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),q&&($|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),$!==0&&F.clear($)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(A){A.setRenderer(this),N=A},this.dispose=function(){n.removeEventListener("webglcontextlost",ue,!1),n.removeEventListener("webglcontextrestored",Ue,!1),n.removeEventListener("webglcontextcreationerror",je,!1),te.dispose(),Z.dispose(),Me.dispose(),C.dispose(),B.dispose(),fe.dispose(),Se.dispose(),ne.dispose(),_e.dispose(),ye.dispose(),ye.removeEventListener("sessionstart",lp),ye.removeEventListener("sessionend",up),br.stop()};function ue(A){A.preventDefault(),Z0("WebGLRenderer: Context Lost."),R=!0}function Ue(){Z0("WebGLRenderer: Context Restored."),R=!1;const A=pe.autoReset,G=ie.enabled,q=ie.autoUpdate,$=ie.needsUpdate,Y=ie.type;xe(),pe.autoReset=A,ie.enabled=G,ie.autoUpdate=q,ie.needsUpdate=$,ie.type=Y}function je(A){st("WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function Pt(A){const G=A.target;G.removeEventListener("dispose",Pt),ht(G)}function ht(A){Mi(A),C.remove(A)}function Mi(A){const G=C.get(A).programs;G!==void 0&&(G.forEach(function(q){_e.releaseProgram(q)}),A.isShaderMaterial&&_e.releaseShaderCache(A))}this.renderBufferDirect=function(A,G,q,$,Y,we){G===null&&(G=ot);const Ce=Y.isMesh&&Y.matrixWorld.determinant()<0,be=iS(A,G,q,$,Y);K.setMaterial($,Ce);let Le=q.index,Fe=1;if($.wireframe===!0){if(Le=se.getWireframeAttribute(q),Le===void 0)return;Fe=2}const Xe=q.drawRange,Ke=q.attributes.position;let ke=Xe.start*Fe,pt=(Xe.start+Xe.count)*Fe;we!==null&&(ke=Math.max(ke,we.start*Fe),pt=Math.min(pt,(we.start+we.count)*Fe)),Le!==null?(ke=Math.max(ke,0),pt=Math.min(pt,Le.count)):Ke!=null&&(ke=Math.max(ke,0),pt=Math.min(pt,Ke.count));const It=pt-ke;if(It<0||It===1/0)return;Se.setup(Y,$,be,q,Le);let At,mt=Ie;if(Le!==null&&(At=X.get(Le),mt=$e,mt.setIndex(At)),Y.isMesh)$.wireframe===!0?(K.setLineWidth($.wireframeLinewidth*Ge()),mt.setMode(F.LINES)):mt.setMode(F.TRIANGLES);else if(Y.isLine){let Yt=$.linewidth;Yt===void 0&&(Yt=1),K.setLineWidth(Yt*Ge()),Y.isLineSegments?mt.setMode(F.LINES):Y.isLineLoop?mt.setMode(F.LINE_LOOP):mt.setMode(F.LINE_STRIP)}else Y.isPoints?mt.setMode(F.POINTS):Y.isSprite&&mt.setMode(F.TRIANGLES);if(Y.isBatchedMesh)if(oe.get("WEBGL_multi_draw"))mt.renderMultiDraw(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount);else{const Yt=Y._multiDrawStarts,Ae=Y._multiDrawCounts,Sn=Y._multiDrawCount,rt=Le?X.get(Le).bytesPerElement:1,In=C.get($).currentProgram.getUniforms();for(let ni=0;ni<Sn;ni++)In.setValue(F,"_gl_DrawID",ni),mt.render(Yt[ni]/rt,Ae[ni])}else if(Y.isInstancedMesh)mt.renderInstances(ke,It,Y.count);else if(q.isInstancedBufferGeometry){const Yt=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,Ae=Math.min(q.instanceCount,Yt);mt.renderInstances(ke,It,Ae)}else mt.render(ke,It)};function ti(A,G,q){A.transparent===!0&&A.side===fi&&A.forceSinglePass===!1?(A.side=_n,A.needsUpdate=!0,mo(A,G,q),A.side=_i,A.needsUpdate=!0,mo(A,G,q),A.side=fi):mo(A,G,q)}this.compile=function(A,G,q=null){q===null&&(q=A),b=Me.get(q),b.init(G),S.push(b),q.traverseVisible(function(Y){Y.isLight&&Y.layers.test(G.layers)&&(b.pushLight(Y),Y.castShadow&&b.pushShadow(Y))}),A!==q&&A.traverseVisible(function(Y){Y.isLight&&Y.layers.test(G.layers)&&(b.pushLight(Y),Y.castShadow&&b.pushShadow(Y))}),b.setupLights();const $=new Set;return A.traverse(function(Y){if(!(Y.isMesh||Y.isPoints||Y.isLine||Y.isSprite))return;const we=Y.material;if(we)if(Array.isArray(we))for(let Ce=0;Ce<we.length;Ce++){const be=we[Ce];ti(be,q,Y),$.add(be)}else ti(we,q,Y),$.add(we)}),b=S.pop(),$},this.compileAsync=function(A,G,q=null){const $=this.compile(A,G,q);return new Promise(Y=>{function we(){if($.forEach(function(Ce){C.get(Ce).currentProgram.isReady()&&$.delete(Ce)}),$.size===0){Y(A);return}setTimeout(we,10)}oe.get("KHR_parallel_shader_compile")!==null?we():setTimeout(we,10)})};let Du=null;function tS(A){Du&&Du(A)}function lp(){br.stop()}function up(){br.start()}const br=new W_;br.setAnimationLoop(tS),typeof self<"u"&&br.setContext(self),this.setAnimationLoop=function(A){Du=A,ye.setAnimationLoop(A),A===null?br.stop():br.start()},ye.addEventListener("sessionstart",lp),ye.addEventListener("sessionend",up),this.render=function(A,G){if(G!==void 0&&G.isCamera!==!0){st("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;N!==null&&N.renderStart(A,G);const q=ye.enabled===!0&&ye.isPresenting===!0,$=x!==null&&(L===null||q)&&x.begin(P,L);if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),G.parent===null&&G.matrixWorldAutoUpdate===!0&&G.updateMatrixWorld(),ye.enabled===!0&&ye.isPresenting===!0&&(x===null||x.isCompositing()===!1)&&(ye.cameraAutoUpdate===!0&&ye.updateCamera(G),G=ye.getCamera()),A.isScene===!0&&A.onBeforeRender(P,A,G,L),b=Me.get(A,S.length),b.init(G),b.state.textureUnits=y.getTextureUnits(),S.push(b),Qe.multiplyMatrices(G.projectionMatrix,G.matrixWorldInverse),Oe.setFromProjectionMatrix(Qe,hi,G.reversedDepth),He=this.localClippingEnabled,nt=Ee.init(this.clippingPlanes,He),T=Z.get(A,w.length),T.init(),w.push(T),ye.enabled===!0&&ye.isPresenting===!0){const Ce=P.xr.getDepthSensingMesh();Ce!==null&&Uu(Ce,G,-1/0,P.sortObjects)}Uu(A,G,0,P.sortObjects),T.finish(),P.sortObjects===!0&&T.sort(Q,ge),Je=ye.enabled===!1||ye.isPresenting===!1||ye.hasDepthSensing()===!1,Je&&te.addToRenderList(T,A),this.info.render.frame++,nt===!0&&Ee.beginShadows();const Y=b.state.shadowsArray;if(ie.render(Y,A,G),nt===!0&&Ee.endShadows(),this.info.autoReset===!0&&this.info.reset(),($&&x.hasRenderPass())===!1){const Ce=T.opaque,be=T.transmissive;if(b.setupLights(),G.isArrayCamera){const Le=G.cameras;if(be.length>0)for(let Fe=0,Xe=Le.length;Fe<Xe;Fe++){const Ke=Le[Fe];fp(Ce,be,A,Ke)}Je&&te.render(A);for(let Fe=0,Xe=Le.length;Fe<Xe;Fe++){const Ke=Le[Fe];cp(T,A,Ke,Ke.viewport)}}else be.length>0&&fp(Ce,be,A,G),Je&&te.render(A),cp(T,A,G)}L!==null&&k===0&&(y.updateMultisampleRenderTarget(L),y.updateRenderTargetMipmap(L)),$&&x.end(P),A.isScene===!0&&A.onAfterRender(P,A,G),Se.resetDefaultState(),z=-1,H=null,S.pop(),S.length>0?(b=S[S.length-1],y.setTextureUnits(b.state.textureUnits),nt===!0&&Ee.setGlobalState(P.clippingPlanes,b.state.camera)):b=null,w.pop(),w.length>0?T=w[w.length-1]:T=null,N!==null&&N.renderEnd()};function Uu(A,G,q,$){if(A.visible===!1)return;if(A.layers.test(G.layers)){if(A.isGroup)q=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(G);else if(A.isLightProbeGrid)b.pushLightProbeGrid(A);else if(A.isLight)b.pushLight(A),A.castShadow&&b.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Oe.intersectsSprite(A)){$&&ve.setFromMatrixPosition(A.matrixWorld).applyMatrix4(Qe);const Ce=fe.update(A),be=A.material;be.visible&&T.push(A,Ce,be,q,ve.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Oe.intersectsObject(A))){const Ce=fe.update(A),be=A.material;if($&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),ve.copy(A.boundingSphere.center)):(Ce.boundingSphere===null&&Ce.computeBoundingSphere(),ve.copy(Ce.boundingSphere.center)),ve.applyMatrix4(A.matrixWorld).applyMatrix4(Qe)),Array.isArray(be)){const Le=Ce.groups;for(let Fe=0,Xe=Le.length;Fe<Xe;Fe++){const Ke=Le[Fe],ke=be[Ke.materialIndex];ke&&ke.visible&&T.push(A,Ce,ke,q,ve.z,Ke)}}else be.visible&&T.push(A,Ce,be,q,ve.z,null)}}const we=A.children;for(let Ce=0,be=we.length;Ce<be;Ce++)Uu(we[Ce],G,q,$)}function cp(A,G,q,$){const{opaque:Y,transmissive:we,transparent:Ce}=A;b.setupLightsView(q),nt===!0&&Ee.setGlobalState(P.clippingPlanes,q),$&&K.viewport(D.copy($)),Y.length>0&&po(Y,G,q),we.length>0&&po(we,G,q),Ce.length>0&&po(Ce,G,q),K.buffers.depth.setTest(!0),K.buffers.depth.setMask(!0),K.buffers.color.setMask(!0),K.setPolygonOffset(!1)}function fp(A,G,q,$){if((q.isScene===!0?q.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[$.id]===void 0){const ke=oe.has("EXT_color_buffer_half_float")||oe.has("EXT_color_buffer_float");b.state.transmissionRenderTarget[$.id]=new vi(1,1,{generateMipmaps:!0,type:ke?Gi:bn,minFilter:zr,samples:Math.max(4,le.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:et.workingColorSpace})}const we=b.state.transmissionRenderTarget[$.id],Ce=$.viewport||D;we.setSize(Ce.z*P.transmissionResolutionScale,Ce.w*P.transmissionResolutionScale);const be=P.getRenderTarget(),Le=P.getActiveCubeFace(),Fe=P.getActiveMipmapLevel();P.setRenderTarget(we),P.getClearColor(ae),de=P.getClearAlpha(),de<1&&P.setClearColor(16777215,.5),P.clear(),Je&&te.render(q);const Xe=P.toneMapping;P.toneMapping=gi;const Ke=$.viewport;if($.viewport!==void 0&&($.viewport=void 0),b.setupLightsView($),nt===!0&&Ee.setGlobalState(P.clippingPlanes,$),po(A,q,$),y.updateMultisampleRenderTarget(we),y.updateRenderTargetMipmap(we),oe.has("WEBGL_multisampled_render_to_texture")===!1){let ke=!1;for(let pt=0,It=G.length;pt<It;pt++){const At=G[pt],{object:mt,geometry:Yt,material:Ae,group:Sn}=At;if(Ae.side===fi&&mt.layers.test($.layers)){const rt=Ae.side;Ae.side=_n,Ae.needsUpdate=!0,dp(mt,q,$,Yt,Ae,Sn),Ae.side=rt,Ae.needsUpdate=!0,ke=!0}}ke===!0&&(y.updateMultisampleRenderTarget(we),y.updateRenderTargetMipmap(we))}P.setRenderTarget(be,Le,Fe),P.setClearColor(ae,de),Ke!==void 0&&($.viewport=Ke),P.toneMapping=Xe}function po(A,G,q){const $=G.isScene===!0?G.overrideMaterial:null;for(let Y=0,we=A.length;Y<we;Y++){const Ce=A[Y],{object:be,geometry:Le,group:Fe}=Ce;let Xe=Ce.material;Xe.allowOverride===!0&&$!==null&&(Xe=$),be.layers.test(q.layers)&&dp(be,G,q,Le,Xe,Fe)}}function dp(A,G,q,$,Y,we){A.onBeforeRender(P,G,q,$,Y,we),A.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),Y.onBeforeRender(P,G,q,$,A,we),Y.transparent===!0&&Y.side===fi&&Y.forceSinglePass===!1?(Y.side=_n,Y.needsUpdate=!0,P.renderBufferDirect(q,G,$,Y,A,we),Y.side=_i,Y.needsUpdate=!0,P.renderBufferDirect(q,G,$,Y,A,we),Y.side=fi):P.renderBufferDirect(q,G,$,Y,A,we),A.onAfterRender(P,G,q,$,Y,we)}function mo(A,G,q){G.isScene!==!0&&(G=ot);const $=C.get(A),Y=b.state.lights,we=b.state.shadowsArray,Ce=Y.state.version,be=_e.getParameters(A,Y.state,we,G,q,b.state.lightProbeGridArray),Le=_e.getProgramCacheKey(be);let Fe=$.programs;$.environment=A.isMeshStandardMaterial||A.isMeshLambertMaterial||A.isMeshPhongMaterial?G.environment:null,$.fog=G.fog;const Xe=A.isMeshStandardMaterial||A.isMeshLambertMaterial&&!A.envMap||A.isMeshPhongMaterial&&!A.envMap;$.envMap=B.get(A.envMap||$.environment,Xe),$.envMapRotation=$.environment!==null&&A.envMap===null?G.environmentRotation:A.envMapRotation,Fe===void 0&&(A.addEventListener("dispose",Pt),Fe=new Map,$.programs=Fe);let Ke=Fe.get(Le);if(Ke!==void 0){if($.currentProgram===Ke&&$.lightsStateVersion===Ce)return pp(A,be),Ke}else be.uniforms=_e.getUniforms(A),N!==null&&A.isNodeMaterial&&N.build(A,q,be),A.onBeforeCompile(be,P),Ke=_e.acquireProgram(be,Le),Fe.set(Le,Ke),$.uniforms=be.uniforms;const ke=$.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(ke.clippingPlanes=Ee.uniform),pp(A,be),$.needsLights=sS(A),$.lightsStateVersion=Ce,$.needsLights&&(ke.ambientLightColor.value=Y.state.ambient,ke.lightProbe.value=Y.state.probe,ke.directionalLights.value=Y.state.directional,ke.directionalLightShadows.value=Y.state.directionalShadow,ke.spotLights.value=Y.state.spot,ke.spotLightShadows.value=Y.state.spotShadow,ke.rectAreaLights.value=Y.state.rectArea,ke.ltc_1.value=Y.state.rectAreaLTC1,ke.ltc_2.value=Y.state.rectAreaLTC2,ke.pointLights.value=Y.state.point,ke.pointLightShadows.value=Y.state.pointShadow,ke.hemisphereLights.value=Y.state.hemi,ke.directionalShadowMatrix.value=Y.state.directionalShadowMatrix,ke.spotLightMatrix.value=Y.state.spotLightMatrix,ke.spotLightMap.value=Y.state.spotLightMap,ke.pointShadowMatrix.value=Y.state.pointShadowMatrix),$.lightProbeGrid=b.state.lightProbeGridArray.length>0,$.currentProgram=Ke,$.uniformsList=null,Ke}function hp(A){if(A.uniformsList===null){const G=A.currentProgram.getUniforms();A.uniformsList=Pl.seqWithValue(G.seq,A.uniforms)}return A.uniformsList}function pp(A,G){const q=C.get(A);q.outputColorSpace=G.outputColorSpace,q.batching=G.batching,q.batchingColor=G.batchingColor,q.instancing=G.instancing,q.instancingColor=G.instancingColor,q.instancingMorph=G.instancingMorph,q.skinning=G.skinning,q.morphTargets=G.morphTargets,q.morphNormals=G.morphNormals,q.morphColors=G.morphColors,q.morphTargetsCount=G.morphTargetsCount,q.numClippingPlanes=G.numClippingPlanes,q.numIntersection=G.numClipIntersection,q.vertexAlphas=G.vertexAlphas,q.vertexTangents=G.vertexTangents,q.toneMapping=G.toneMapping}function nS(A,G){if(A.length===0)return null;if(A.length===1)return A[0].texture!==null?A[0]:null;E.setFromMatrixPosition(G.matrixWorld);for(let q=0,$=A.length;q<$;q++){const Y=A[q];if(Y.texture!==null&&Y.boundingBox.containsPoint(E))return Y}return null}function iS(A,G,q,$,Y){G.isScene!==!0&&(G=ot),y.resetTextureUnits();const we=G.fog,Ce=$.isMeshStandardMaterial||$.isMeshLambertMaterial||$.isMeshPhongMaterial?G.environment:null,be=L===null?P.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:et.workingColorSpace,Le=$.isMeshStandardMaterial||$.isMeshLambertMaterial&&!$.envMap||$.isMeshPhongMaterial&&!$.envMap,Fe=B.get($.envMap||Ce,Le),Xe=$.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,Ke=!!q.attributes.tangent&&(!!$.normalMap||$.anisotropy>0),ke=!!q.morphAttributes.position,pt=!!q.morphAttributes.normal,It=!!q.morphAttributes.color;let At=gi;$.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(At=P.toneMapping);const mt=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,Yt=mt!==void 0?mt.length:0,Ae=C.get($),Sn=b.state.lights;if(nt===!0&&(He===!0||A!==H)){const vt=A===H&&$.id===z;Ee.setState($,A,vt)}let rt=!1;$.version===Ae.__version?(Ae.needsLights&&Ae.lightsStateVersion!==Sn.state.version||Ae.outputColorSpace!==be||Y.isBatchedMesh&&Ae.batching===!1||!Y.isBatchedMesh&&Ae.batching===!0||Y.isBatchedMesh&&Ae.batchingColor===!0&&Y.colorTexture===null||Y.isBatchedMesh&&Ae.batchingColor===!1&&Y.colorTexture!==null||Y.isInstancedMesh&&Ae.instancing===!1||!Y.isInstancedMesh&&Ae.instancing===!0||Y.isSkinnedMesh&&Ae.skinning===!1||!Y.isSkinnedMesh&&Ae.skinning===!0||Y.isInstancedMesh&&Ae.instancingColor===!0&&Y.instanceColor===null||Y.isInstancedMesh&&Ae.instancingColor===!1&&Y.instanceColor!==null||Y.isInstancedMesh&&Ae.instancingMorph===!0&&Y.morphTexture===null||Y.isInstancedMesh&&Ae.instancingMorph===!1&&Y.morphTexture!==null||Ae.envMap!==Fe||$.fog===!0&&Ae.fog!==we||Ae.numClippingPlanes!==void 0&&(Ae.numClippingPlanes!==Ee.numPlanes||Ae.numIntersection!==Ee.numIntersection)||Ae.vertexAlphas!==Xe||Ae.vertexTangents!==Ke||Ae.morphTargets!==ke||Ae.morphNormals!==pt||Ae.morphColors!==It||Ae.toneMapping!==At||Ae.morphTargetsCount!==Yt||!!Ae.lightProbeGrid!=b.state.lightProbeGridArray.length>0)&&(rt=!0):(rt=!0,Ae.__version=$.version);let In=Ae.currentProgram;rt===!0&&(In=mo($,G,Y),N&&$.isNodeMaterial&&N.onUpdateProgram($,In,Ae));let ni=!1,Wi=!1,ns=!1;const gt=In.getUniforms(),Nt=Ae.uniforms;if(K.useProgram(In.program)&&(ni=!0,Wi=!0,ns=!0),$.id!==z&&(z=$.id,Wi=!0),Ae.needsLights){const vt=nS(b.state.lightProbeGridArray,Y);Ae.lightProbeGrid!==vt&&(Ae.lightProbeGrid=vt,Wi=!0)}if(ni||H!==A){K.buffers.depth.getReversed()&&A.reversedDepth!==!0&&(A._reversedDepth=!0,A.updateProjectionMatrix()),gt.setValue(F,"projectionMatrix",A.projectionMatrix),gt.setValue(F,"viewMatrix",A.matrixWorldInverse);const Xi=gt.map.cameraPosition;Xi!==void 0&&Xi.setValue(F,ut.setFromMatrixPosition(A.matrixWorld)),le.logarithmicDepthBuffer&&gt.setValue(F,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),($.isMeshPhongMaterial||$.isMeshToonMaterial||$.isMeshLambertMaterial||$.isMeshBasicMaterial||$.isMeshStandardMaterial||$.isShaderMaterial)&&gt.setValue(F,"isOrthographic",A.isOrthographicCamera===!0),H!==A&&(H=A,Wi=!0,ns=!0)}if(Ae.needsLights&&(Sn.state.directionalShadowMap.length>0&&gt.setValue(F,"directionalShadowMap",Sn.state.directionalShadowMap,y),Sn.state.spotShadowMap.length>0&&gt.setValue(F,"spotShadowMap",Sn.state.spotShadowMap,y),Sn.state.pointShadowMap.length>0&&gt.setValue(F,"pointShadowMap",Sn.state.pointShadowMap,y)),Y.isSkinnedMesh){gt.setOptional(F,Y,"bindMatrix"),gt.setOptional(F,Y,"bindMatrixInverse");const vt=Y.skeleton;vt&&(vt.boneTexture===null&&vt.computeBoneTexture(),gt.setValue(F,"boneTexture",vt.boneTexture,y))}Y.isBatchedMesh&&(gt.setOptional(F,Y,"batchingTexture"),gt.setValue(F,"batchingTexture",Y._matricesTexture,y),gt.setOptional(F,Y,"batchingIdTexture"),gt.setValue(F,"batchingIdTexture",Y._indirectTexture,y),gt.setOptional(F,Y,"batchingColorTexture"),Y._colorsTexture!==null&&gt.setValue(F,"batchingColorTexture",Y._colorsTexture,y));const ji=q.morphAttributes;if((ji.position!==void 0||ji.normal!==void 0||ji.color!==void 0)&&ce.update(Y,q,In),(Wi||Ae.receiveShadow!==Y.receiveShadow)&&(Ae.receiveShadow=Y.receiveShadow,gt.setValue(F,"receiveShadow",Y.receiveShadow)),($.isMeshStandardMaterial||$.isMeshLambertMaterial||$.isMeshPhongMaterial)&&$.envMap===null&&G.environment!==null&&(Nt.envMapIntensity.value=G.environmentIntensity),Nt.dfgLUT!==void 0&&(Nt.dfgLUT.value=TA()),Wi){if(gt.setValue(F,"toneMappingExposure",P.toneMappingExposure),Ae.needsLights&&rS(Nt,ns),we&&$.fog===!0&&ee.refreshFogUniforms(Nt,we),ee.refreshMaterialUniforms(Nt,$,De,Be,b.state.transmissionRenderTarget[A.id]),Ae.needsLights&&Ae.lightProbeGrid){const vt=Ae.lightProbeGrid;Nt.probesSH.value=vt.texture,Nt.probesMin.value.copy(vt.boundingBox.min),Nt.probesMax.value.copy(vt.boundingBox.max),Nt.probesResolution.value.copy(vt.resolution)}Pl.upload(F,hp(Ae),Nt,y)}if($.isShaderMaterial&&$.uniformsNeedUpdate===!0&&(Pl.upload(F,hp(Ae),Nt,y),$.uniformsNeedUpdate=!1),$.isSpriteMaterial&&gt.setValue(F,"center",Y.center),gt.setValue(F,"modelViewMatrix",Y.modelViewMatrix),gt.setValue(F,"normalMatrix",Y.normalMatrix),gt.setValue(F,"modelMatrix",Y.matrixWorld),$.uniformsGroups!==void 0){const vt=$.uniformsGroups;for(let Xi=0,is=vt.length;Xi<is;Xi++){const mp=vt[Xi];ne.update(mp,In),ne.bind(mp,In)}}return In}function rS(A,G){A.ambientLightColor.needsUpdate=G,A.lightProbe.needsUpdate=G,A.directionalLights.needsUpdate=G,A.directionalLightShadows.needsUpdate=G,A.pointLights.needsUpdate=G,A.pointLightShadows.needsUpdate=G,A.spotLights.needsUpdate=G,A.spotLightShadows.needsUpdate=G,A.rectAreaLights.needsUpdate=G,A.hemisphereLights.needsUpdate=G}function sS(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return U},this.getActiveMipmapLevel=function(){return k},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(A,G,q){const $=C.get(A);$.__autoAllocateDepthBuffer=A.resolveDepthBuffer===!1,$.__autoAllocateDepthBuffer===!1&&($.__useRenderToTexture=!1),C.get(A.texture).__webglTexture=G,C.get(A.depthTexture).__webglTexture=$.__autoAllocateDepthBuffer?void 0:q,$.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(A,G){const q=C.get(A);q.__webglFramebuffer=G,q.__useDefaultFramebuffer=G===void 0};const aS=F.createFramebuffer();this.setRenderTarget=function(A,G=0,q=0){L=A,U=G,k=q;let $=null,Y=!1,we=!1;if(A){const be=C.get(A);if(be.__useDefaultFramebuffer!==void 0){K.bindFramebuffer(F.FRAMEBUFFER,be.__webglFramebuffer),D.copy(A.viewport),j.copy(A.scissor),J=A.scissorTest,K.viewport(D),K.scissor(j),K.setScissorTest(J),z=-1;return}else if(be.__webglFramebuffer===void 0)y.setupRenderTarget(A);else if(be.__hasExternalTextures)y.rebindTextures(A,C.get(A.texture).__webglTexture,C.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const Xe=A.depthTexture;if(be.__boundDepthTexture!==Xe){if(Xe!==null&&C.has(Xe)&&(A.width!==Xe.image.width||A.height!==Xe.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");y.setupDepthRenderbuffer(A)}}const Le=A.texture;(Le.isData3DTexture||Le.isDataArrayTexture||Le.isCompressedArrayTexture)&&(we=!0);const Fe=C.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(Fe[G])?$=Fe[G][q]:$=Fe[G],Y=!0):A.samples>0&&y.useMultisampledRTT(A)===!1?$=C.get(A).__webglMultisampledFramebuffer:Array.isArray(Fe)?$=Fe[q]:$=Fe,D.copy(A.viewport),j.copy(A.scissor),J=A.scissorTest}else D.copy(he).multiplyScalar(De).floor(),j.copy(Pe).multiplyScalar(De).floor(),J=ze;if(q!==0&&($=aS),K.bindFramebuffer(F.FRAMEBUFFER,$)&&K.drawBuffers(A,$),K.viewport(D),K.scissor(j),K.setScissorTest(J),Y){const be=C.get(A.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+G,be.__webglTexture,q)}else if(we){const be=G;for(let Le=0;Le<A.textures.length;Le++){const Fe=C.get(A.textures[Le]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+Le,Fe.__webglTexture,q,be)}}else if(A!==null&&q!==0){const be=C.get(A.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,be.__webglTexture,q)}z=-1},this.readRenderTargetPixels=function(A,G,q,$,Y,we,Ce,be=0){if(!(A&&A.isWebGLRenderTarget)){st("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Le=C.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Ce!==void 0&&(Le=Le[Ce]),Le){K.bindFramebuffer(F.FRAMEBUFFER,Le);try{const Fe=A.textures[be],Xe=Fe.format,Ke=Fe.type;if(A.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+be),!le.textureFormatReadable(Xe)){st("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!le.textureTypeReadable(Ke)){st("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}G>=0&&G<=A.width-$&&q>=0&&q<=A.height-Y&&F.readPixels(G,q,$,Y,O.convert(Xe),O.convert(Ke),we)}finally{const Fe=L!==null?C.get(L).__webglFramebuffer:null;K.bindFramebuffer(F.FRAMEBUFFER,Fe)}}},this.readRenderTargetPixelsAsync=async function(A,G,q,$,Y,we,Ce,be=0){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Le=C.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Ce!==void 0&&(Le=Le[Ce]),Le)if(G>=0&&G<=A.width-$&&q>=0&&q<=A.height-Y){K.bindFramebuffer(F.FRAMEBUFFER,Le);const Fe=A.textures[be],Xe=Fe.format,Ke=Fe.type;if(A.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+be),!le.textureFormatReadable(Xe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!le.textureTypeReadable(Ke))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ke=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,ke),F.bufferData(F.PIXEL_PACK_BUFFER,we.byteLength,F.STREAM_READ),F.readPixels(G,q,$,Y,O.convert(Xe),O.convert(Ke),0);const pt=L!==null?C.get(L).__webglFramebuffer:null;K.bindFramebuffer(F.FRAMEBUFFER,pt);const It=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await G2(F,It,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,ke),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,we),F.deleteBuffer(ke),F.deleteSync(It),we}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(A,G=null,q=0){const $=Math.pow(2,-q),Y=Math.floor(A.image.width*$),we=Math.floor(A.image.height*$),Ce=G!==null?G.x:0,be=G!==null?G.y:0;y.setTexture2D(A,0),F.copyTexSubImage2D(F.TEXTURE_2D,q,0,0,Ce,be,Y,we),K.unbindTexture()};const oS=F.createFramebuffer(),lS=F.createFramebuffer();this.copyTextureToTexture=function(A,G,q=null,$=null,Y=0,we=0){let Ce,be,Le,Fe,Xe,Ke,ke,pt,It;const At=A.isCompressedTexture?A.mipmaps[we]:A.image;if(q!==null)Ce=q.max.x-q.min.x,be=q.max.y-q.min.y,Le=q.isBox3?q.max.z-q.min.z:1,Fe=q.min.x,Xe=q.min.y,Ke=q.isBox3?q.min.z:0;else{const Nt=Math.pow(2,-Y);Ce=Math.floor(At.width*Nt),be=Math.floor(At.height*Nt),A.isDataArrayTexture?Le=At.depth:A.isData3DTexture?Le=Math.floor(At.depth*Nt):Le=1,Fe=0,Xe=0,Ke=0}$!==null?(ke=$.x,pt=$.y,It=$.z):(ke=0,pt=0,It=0);const mt=O.convert(G.format),Yt=O.convert(G.type);let Ae;G.isData3DTexture?(y.setTexture3D(G,0),Ae=F.TEXTURE_3D):G.isDataArrayTexture||G.isCompressedArrayTexture?(y.setTexture2DArray(G,0),Ae=F.TEXTURE_2D_ARRAY):(y.setTexture2D(G,0),Ae=F.TEXTURE_2D),K.activeTexture(F.TEXTURE0),K.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,G.flipY),K.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,G.premultiplyAlpha),K.pixelStorei(F.UNPACK_ALIGNMENT,G.unpackAlignment);const Sn=K.getParameter(F.UNPACK_ROW_LENGTH),rt=K.getParameter(F.UNPACK_IMAGE_HEIGHT),In=K.getParameter(F.UNPACK_SKIP_PIXELS),ni=K.getParameter(F.UNPACK_SKIP_ROWS),Wi=K.getParameter(F.UNPACK_SKIP_IMAGES);K.pixelStorei(F.UNPACK_ROW_LENGTH,At.width),K.pixelStorei(F.UNPACK_IMAGE_HEIGHT,At.height),K.pixelStorei(F.UNPACK_SKIP_PIXELS,Fe),K.pixelStorei(F.UNPACK_SKIP_ROWS,Xe),K.pixelStorei(F.UNPACK_SKIP_IMAGES,Ke);const ns=A.isDataArrayTexture||A.isData3DTexture,gt=G.isDataArrayTexture||G.isData3DTexture;if(A.isDepthTexture){const Nt=C.get(A),ji=C.get(G),vt=C.get(Nt.__renderTarget),Xi=C.get(ji.__renderTarget);K.bindFramebuffer(F.READ_FRAMEBUFFER,vt.__webglFramebuffer),K.bindFramebuffer(F.DRAW_FRAMEBUFFER,Xi.__webglFramebuffer);for(let is=0;is<Le;is++)ns&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,C.get(A).__webglTexture,Y,Ke+is),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,C.get(G).__webglTexture,we,It+is)),F.blitFramebuffer(Fe,Xe,Ce,be,ke,pt,Ce,be,F.DEPTH_BUFFER_BIT,F.NEAREST);K.bindFramebuffer(F.READ_FRAMEBUFFER,null),K.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(Y!==0||A.isRenderTargetTexture||C.has(A)){const Nt=C.get(A),ji=C.get(G);K.bindFramebuffer(F.READ_FRAMEBUFFER,oS),K.bindFramebuffer(F.DRAW_FRAMEBUFFER,lS);for(let vt=0;vt<Le;vt++)ns?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,Nt.__webglTexture,Y,Ke+vt):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,Nt.__webglTexture,Y),gt?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,ji.__webglTexture,we,It+vt):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,ji.__webglTexture,we),Y!==0?F.blitFramebuffer(Fe,Xe,Ce,be,ke,pt,Ce,be,F.COLOR_BUFFER_BIT,F.NEAREST):gt?F.copyTexSubImage3D(Ae,we,ke,pt,It+vt,Fe,Xe,Ce,be):F.copyTexSubImage2D(Ae,we,ke,pt,Fe,Xe,Ce,be);K.bindFramebuffer(F.READ_FRAMEBUFFER,null),K.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else gt?A.isDataTexture||A.isData3DTexture?F.texSubImage3D(Ae,we,ke,pt,It,Ce,be,Le,mt,Yt,At.data):G.isCompressedArrayTexture?F.compressedTexSubImage3D(Ae,we,ke,pt,It,Ce,be,Le,mt,At.data):F.texSubImage3D(Ae,we,ke,pt,It,Ce,be,Le,mt,Yt,At):A.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,we,ke,pt,Ce,be,mt,Yt,At.data):A.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,we,ke,pt,At.width,At.height,mt,At.data):F.texSubImage2D(F.TEXTURE_2D,we,ke,pt,Ce,be,mt,Yt,At);K.pixelStorei(F.UNPACK_ROW_LENGTH,Sn),K.pixelStorei(F.UNPACK_IMAGE_HEIGHT,rt),K.pixelStorei(F.UNPACK_SKIP_PIXELS,In),K.pixelStorei(F.UNPACK_SKIP_ROWS,ni),K.pixelStorei(F.UNPACK_SKIP_IMAGES,Wi),we===0&&G.generateMipmaps&&F.generateMipmap(Ae),K.unbindTexture()},this.initRenderTarget=function(A){C.get(A).__webglFramebuffer===void 0&&y.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?y.setTextureCube(A,0):A.isData3DTexture?y.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?y.setTexture2DArray(A,0):y.setTexture2D(A,0),K.unbindTexture()},this.resetState=function(){U=0,k=0,L=null,K.reset(),Se.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return hi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const n=this.getContext();n.drawingBufferColorSpace=et._getDrawingBufferColorSpace(t),n.unpackColorSpace=et._getUnpackColorSpace()}}const ol=225e6,Ym=4.5,qm=14,Km=90,wA=[1,10,100,1e3],Fd="AUTO",Od="WIDE",Q_="CHASE",kd="POV",J_="FLYBY",eS="ORBITAL",jc=[Fd,Od,Q_,kd,J_,eS],xA=[{id:"burn",prog:.28,label:"MID-COURSE CORRECTION BURN",sub:"Δv = +4.2 m/s  ·  Duration: 8.3 sec",color:"#f59e0b",duration:5},{id:"flare",prog:.47,label:"SOLAR PARTICLE EVENT",sub:"Class M5.2 flare  ·  Radiation shield nominal",color:"#ef4444",duration:6},{id:"update",prog:.63,label:"MISSION CONTROL UPDATE",sub:"All systems nominal  ·  Go for orbital insertion",color:"#22c55e",duration:5},{id:"nav",prog:.79,label:"NAVIGATION CORRECTION",sub:"Inclination +0.003°  ·  ΔR = 812 km",color:"#60a5fa",duration:4},{id:"comm",prog:.9,label:"COMMS DELAY  ·  14.2 MIN",sub:"Mars approach confirmed  ·  Stand by",color:"#a78bfa",duration:5}],dn=new V(-9,0,0),ui=new V(22,0,0),Il=2.2,Zm=1.5,AA=new V(-1,.35,.6).normalize();function Nr(e,t,n){return e+(t-e)*Math.max(0,Math.min(1,n))}function ar(e,t,n){return Math.max(t,Math.min(n,e))}function Qm(e){const t=Math.floor(Math.max(0,e)),n=Math.floor(t/3600),i=Math.floor(t%3600/60),r=t%60;return`${String(n).padStart(2,"0")}:${String(i).padStart(2,"0")}:${String(r).padStart(2,"0")}`}function CA(e){const t=Math.max(0,e);return t>=1e6?`${(t/1e6).toFixed(2)}M km`:t>=1e3?`${(t/1e3).toFixed(0)}k km`:`${t.toFixed(0)} km`}function RA(e,t,n,i,r,s,a){return[(1-e)*(1-e)*t+2*(1-e)*e*i+e*e*s,(1-e)*(1-e)*n+2*(1-e)*e*r+e*e*a]}function PA(){const n=document.createElement("canvas");n.width=2048,n.height=1024;const i=n.getContext("2d"),r=i.createLinearGradient(0,0,0,1024);r.addColorStop(0,"#0a2855"),r.addColorStop(.5,"#0d3a70"),r.addColorStop(1,"#0a2855"),i.fillStyle=r,i.fillRect(0,0,2048,1024);for(let l=0;l<180;l++){const u=(Math.sin(l*3.7)*.5+.5)*2048,f=(Math.cos(l*2.9)*.5+.5)*1024,h=i.createRadialGradient(u,f,0,u,f,2048*.022);h.addColorStop(0,"rgba(30,100,200,0.18)"),h.addColorStop(1,"rgba(0,0,0,0)"),i.fillStyle=h,i.beginPath(),i.ellipse(u,f,2048*.022,1024*.01,l,0,Math.PI*2),i.fill()}i.globalCompositeOperation="source-over",[{x:2048*.16,y:1024*.32,rx:2048*.085,ry:1024*.2,rot:.25,c:"#2d6b28"},{x:2048*.12,y:1024*.46,rx:2048*.065,ry:1024*.13,rot:.08,c:"#316d24"},{x:2048*.2,y:1024*.64,rx:2048*.05,ry:1024*.18,rot:-.08,c:"#3a7a30"},{x:2048*.455,y:1024*.29,rx:2048*.048,ry:1024*.11,rot:.1,c:"#4a8a3a"},{x:2048*.465,y:1024*.54,rx:2048*.058,ry:1024*.22,rot:.05,c:"#7a6a28"},{x:2048*.62,y:1024*.28,rx:2048*.16,ry:1024*.19,rot:.05,c:"#4a8040"},{x:2048*.66,y:1024*.5,rx:2048*.04,ry:1024*.12,rot:.1,c:"#3a7030"},{x:2048*.765,y:1024*.62,rx:2048*.055,ry:1024*.08,rot:.18,c:"#8a7830"}].forEach(({x:l,y:u,rx:f,ry:h,rot:c,c:p})=>{i.save(),i.translate(l,u),i.rotate(c),i.fillStyle=p,i.beginPath(),i.ellipse(0,0,f,h,0,0,Math.PI*2),i.fill(),i.fillStyle="rgba(0,0,0,0.12)";for(let m=0;m<8;m++)i.beginPath(),i.ellipse((Math.random()-.5)*f,(Math.random()-.5)*h,f*.3*Math.random(),h*.25*Math.random(),Math.random(),0,Math.PI*2),i.fill();i.restore()}),i.fillStyle="rgba(255,255,255,0.22)";for(let l=0;l<200;l++){const u=(Math.sin(l*4.1+1)*.5+.5)*2048,f=(Math.cos(l*3.7+2)*.5+.5)*1024;i.beginPath(),i.ellipse(u,f,2048*.038,1024*.018,l*.8,0,Math.PI*2),i.fill()}i.fillStyle="rgba(255,255,255,0.14)";for(let l=0;l<120;l++){const u=(Math.sin(l*5.3+3)*.5+.5)*2048,f=(Math.cos(l*4.1+1)*.5+.5)*1024;i.beginPath(),i.ellipse(u,f,2048*.055,1024*.025,l*1.1,0,Math.PI*2),i.fill()}const a=i.createLinearGradient(0,0,0,1024*.1);a.addColorStop(0,"rgba(235,245,255,0.95)"),a.addColorStop(1,"rgba(200,225,255,0)"),i.fillStyle=a,i.fillRect(0,0,2048,1024*.1);const o=i.createLinearGradient(0,1024*.9,0,1024);return o.addColorStop(0,"rgba(200,225,255,0)"),o.addColorStop(1,"rgba(235,245,255,0.90)"),i.fillStyle=o,i.fillRect(0,1024*.9,2048,1024*.1),new ho(n)}function IA(){const n=document.createElement("canvas");n.width=2048,n.height=1024;const i=n.getContext("2d");return i.fillStyle="#000",i.fillRect(0,0,2048,1024),[[2048*.2,1024*.33,18],[2048*.15,1024*.4,14],[2048*.22,1024*.39,10],[2048*.47,1024*.3,16],[2048*.5,1024*.32,12],[2048*.44,1024*.31,10],[2048*.58,1024*.3,14],[2048*.64,1024*.31,12],[2048*.7,1024*.29,10],[2048*.72,1024*.35,9],[2048*.66,1024*.4,8],[2048*.22,1024*.62,9],[2048*.47,1024*.5,8],[2048*.77,1024*.63,7],[2048*.66,1024*.48,10]].forEach(([s,a,o])=>{const l=i.createRadialGradient(s,a,0,s,a,57.344);l.addColorStop(0,"rgba(255,220,100,0.85)"),l.addColorStop(.5,"rgba(255,180,60,0.40)"),l.addColorStop(1,"rgba(0,0,0,0)"),i.fillStyle=l,i.beginPath(),i.arc(s,a,2048*.028,0,Math.PI*2),i.fill();for(let u=0;u<o;u++){const f=(Math.random()-.5)*2048*.035,h=(Math.random()-.5)*1024*.03,c=.35+Math.random()*.55;i.fillStyle=`rgba(255,${150+Math.random()*105|0},${40+Math.random()*60|0},${c})`,i.fillRect(s+f|0,a+h|0,2,2)}}),new ho(n)}function NA(){const n=document.createElement("canvas");n.width=1024,n.height=512;const i=n.getContext("2d");return i.fillStyle="#888",i.fillRect(0,0,1024,512),i.fillStyle="#222",[[1024*.16,512*.32,1024*.085,512*.2,.25],[1024*.12,512*.46,1024*.065,512*.13,.08],[1024*.2,512*.64,1024*.05,512*.18,-.08],[1024*.455,512*.29,1024*.048,512*.11,.1],[1024*.465,512*.54,1024*.058,512*.22,.05],[1024*.62,512*.28,1024*.16,512*.19,.05],[1024*.66,512*.5,1024*.04,512*.12,.1],[1024*.765,512*.62,1024*.055,512*.08,.18]].forEach(([r,s,a,o,l])=>{i.save(),i.translate(r,s),i.rotate(l),i.beginPath(),i.ellipse(0,0,a,o,0,0,Math.PI*2),i.fill(),i.restore()}),new ho(n)}function LA(){const n=document.createElement("canvas");n.width=2048,n.height=1024;const i=n.getContext("2d"),r=i.createLinearGradient(0,0,0,1024);r.addColorStop(0,"#a03818"),r.addColorStop(.5,"#c04822"),r.addColorStop(1,"#a03818"),i.fillStyle=r,i.fillRect(0,0,2048,1024),[[2048*.4,1024*.42,2048*.18,1024*.15,0,"rgba(160,50,16,0.42)"],[2048*.7,1024*.5,2048*.14,1024*.18,0,"rgba(185,72,24,0.35)"],[2048*.2,1024*.62,2048*.12,1024*.12,0,"rgba(135,38,10,0.38)"],[2048*.55,1024*.25,2048*.22,1024*.1,0,"rgba(190,82,28,0.28)"],[2048*.8,1024*.35,2048*.1,1024*.14,0,"rgba(155,55,18,0.32)"],[2048*.05,1024*.55,2048*.08,1024*.16,0,"rgba(175,62,20,0.30)"]].forEach(([l,u,f,h,c,p])=>{i.save(),i.translate(l,u),i.rotate(c),i.fillStyle=p,i.beginPath(),i.ellipse(0,0,f,h,0,0,Math.PI*2),i.fill(),i.fillStyle="rgba(0,0,0,0.10)";for(let m=0;m<6;m++)i.beginPath(),i.ellipse((Math.random()-.5)*f,(Math.random()-.5)*h,f*.25,h*.2,Math.random(),0,Math.PI*2),i.fill();i.restore()}),i.save(),i.translate(2048*.48,1024*.46),i.rotate(-.14),i.fillStyle="rgba(80,18,4,0.55)",i.fillRect(-2048*.2,-1024*.025,2048*.4,1024*.042),i.fillStyle="rgba(60,12,2,0.30)",i.fillRect(-2048*.2,-1024*.014,2048*.4,1024*.028),i.restore();const s=i.createRadialGradient(2048*.28,1024*.4,0,2048*.28,1024*.4,2048*.055);s.addColorStop(0,"rgba(215,95,38,0.65)"),s.addColorStop(.6,"rgba(185,70,24,0.20)"),s.addColorStop(1,"rgba(0,0,0,0)"),i.fillStyle=s,i.beginPath(),i.arc(2048*.28,1024*.4,2048*.055,0,Math.PI*2),i.fill(),i.fillStyle="rgba(210,115,48,0.14)",i.fillRect(0,1024*.42,2048,1024*.18);const a=i.createLinearGradient(0,0,0,1024*.1);a.addColorStop(0,"rgba(235,228,220,0.90)"),a.addColorStop(1,"rgba(0,0,0,0)"),i.fillStyle=a,i.fillRect(0,0,2048,1024*.1);const o=i.createLinearGradient(0,1024*.9,0,1024);return o.addColorStop(0,"rgba(0,0,0,0)"),o.addColorStop(1,"rgba(225,218,210,0.82)"),i.fillStyle=o,i.fillRect(0,1024*.9,2048,1024*.1),new ho(n)}const Jm=`
varying vec3 vNormal;
